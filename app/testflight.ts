export type TestFlightBuild = {
  ...
  publicBetaState: "waitingForReview" | "needsExternalBuild" | "needsReviewAccount";
};
...
export const testFlightBuilds: TestFlightBuild[] = [
  ...
  { slug: "htoms-brief", appName: "HtOMS 브리프", build: "202608252204", uploadedAt: "2026-08-25T22:07:03+09:00", inviteUrl: null, publicBetaState: "needsReviewAccount" },
