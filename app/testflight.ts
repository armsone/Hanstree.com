export type TestFlightBuild = {
  slug: "ccmb" | "nasfinder" | "hanclip" | "stand" | "htoms-brief" | "starmanager" | "button" | "whattoeat" | "denimdex";
  appName: string;
  build: string | null;
...
export const testFlightBuilds: TestFlightBuild[] = [
  { slug: "ccmb", appName: "CCMB", build: "202609021538", uploadedAt: "2026-09-01T23:55:28-07:00", expiresAt: "2026-11-30T22:55:28-08:00", inviteUrl: "https://testflight.apple.com/join/q9jesHZa", inviteAvailable: true, publicBetaState: "approved" },
  ...
  { slug: "starmanager", appName: "Stargram", build: "202609242307", uploadedAt: "2026-09-24T08:01:19-07:00", expiresAt: "2026-12-23T07:01:19-08:00", inviteUrl: "https://testflight.apple.com/join/nzmW4WxW", inviteAvailable: true, publicBetaState: "waitingForReview" },
