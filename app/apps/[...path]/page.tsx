      ...
      <section className="screens-section" id="screens">
        <div className="shell">
          ...
          {app.screenshots && app.screenshots.length > 1 ? (
            <div className="screenshot-rail">{app.screenshots.map((screen) => <figure key={screen.src}><img src={screen.src} alt={screen.alt} loading="lazy" /><figcaption>{screen.alt}</figcaption></figure>)}</div>
          ) : (
