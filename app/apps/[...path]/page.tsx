...
const productCampaigns = {
  ...
  ccmb: {
    ...
    advantages: [
      ["01", "FOUR RINGS", "네 서비스의 남은 여유를 한눈에.", "Codex·Claude·Gemini·Grok의 사용량과 크레딧 정보를 4열 링으로 모으고, 제공되지 않는 값도 빈 링과 ‘—’로 자리를 지킵니다.", "서비스를 하나씩 열지 않고 다음 작업에 쓸 도구를 빠르게 가늠하며, 없는 수치를 100%로 오해하지 않습니다."],
