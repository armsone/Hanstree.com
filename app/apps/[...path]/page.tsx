...
const productCampaigns = {
  "super-thumbnail": {
    ...
    advantages: [
      ...
      ["02", "QUEUE + PARALLEL", "폴더는 안전하게 줄 세우고, 파일은 동시에 만듭니다.", "여러 폴더를 대기열에 등록하고 각 폴더 안의 사진과 영상을 자동·1·2·4·8개 작업자로 병렬 처리합니다.", "자동 모드는 저장소와 Mac 발열 상태에 맞춰 처리 수를 조절합니다.", "recursive-scan"],
