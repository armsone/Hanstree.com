  ...
  return (
    <main className={`app-page app-${app.slug} theme-${app.theme}`}>
      ...
      <section className="progress-section shell" id="progress">
        <div className="section-heading reveal"><div><p className="eyebrow">BUILDING IN PUBLIC</p><h2>현재 진행 상황</h2></div><p>{app.slug === "hanai" ? "숫자보다 실제 상태를 보여드립니다. 마지막 내용 확인: 2026년 8월 29일." : "숫자보다 실제 상태를 보여드립니다. 마지막 내용 확인: 2026년 8월 25일."}</p></div>
...
const productCampaigns = {
  ...
  ccmb: {
    ...
    description: "We track Codex, Claude, and Gemini at a glance: remaining quota, credits, reset trend, and current limits for Spark/Fable usage, all packed into three rings and menu-bar indicators.",
    ...
    facts: [["03", "서비스 상태 패널"], ["02", "메뉴 + 항상 표시"], ["LOCAL", "CLI 세션 기반"]],
    advantages: [
