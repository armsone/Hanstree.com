...
type Release = {
  ...
  releaseUrl?: string;
  asset?: { name: string; size: number; contentType: string; downloadCount: number } | null;
};
    ...
    <div ref={containerRef}>
      ...
      <section className="android-install-guide" aria-labelledby="android-install-title">
        ...
        <ol className="install-steps">
          <li><span>01</span><div><AdvantageVisual variant={installStepVisuals[0]} /><h4>공식 파일인지 확인</h4><p>주소가 <strong>github.com/armsone</strong>으로 시작하는지, 앱 이름·제품 버전·APK 파일명이 이 페이지의 정보와 맞는지 확인합니다. 메신저나 파일 공유 사이트에서 다시 받은 APK는 설치하지 않습니다.</p></div></li>
