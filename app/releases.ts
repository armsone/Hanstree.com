...
export const RELEASE_DOWNLOADS: Record<DownloadKey, ReleaseDownload> = {
  ...
  "NasFinder-Android": {
    ...
    assetPattern: /\.apk$/i,
    fallbackUrl: "https://github.com/armsone/NasFinder-Android/releases/download/android-v2.2.3/NasFinder-Android-2.2.3.apk",
  },
  "NasFinder-Mac": {
    label: "NasFinder Mac",
    repo: "NasFinder",
    assetPattern: /^NasFinder-Mac-\d+\.\d+\.\d+-\d{12}\.dmg$/i,
    fallbackUrl: "https://github.com/armsone/NasFinder/releases/download/mac-v2.2.3/NasFinder-Mac-2.2.3-202609051155.dmg",
  },
  "NasFinder-Super-Thumbnail": {
  ...
  "HanClip-Android": {
    ...
    assetPattern: /\.apk$/i,
    fallbackUrl: "https://github.com/armsone/HanClip-Android/releases/download/android-v2.3.0/HanClip-Android-2.3.0.apk",
  },
  "S.tand-macOS": {
    label: "S.tand Mac",
    repo: "S.tand",
    assetPattern: /^S\.tand-macOS-.*\.dmg$/i,
    fallbackUrl: "https://github.com/armsone/S.tand/releases/download/macos-v2.5.3/S.tand-macOS-2.5.3.dmg",
  },
  "S.tand-Android": {
    label: "S.tand Android",
    repo: "S.tand-Android",
    assetPattern: /\.apk$/i,
    fallbackUrl: "https://github.com/armsone/S.tand-Android/releases/download/android-v2.5.4/S.tand-Android-2.5.4.apk",
  },
  CCMB: {
    label: "CCMB Mac",
    repo: "CCMB",
    assetPattern: /\.dmg$/i,
    fallbackUrl: "https://github.com/armsone/CCMB/releases/download/v2.0.25/CCMB-2.0.25.dmg",
  },
  BTN: {
    label: "BTN Mac",
    repo: "BTN",
    assetPattern: /\.dmg$/i,
    fallbackUrl: "https://github.com/armsone/BTN/releases/download/v2.0.3/BTN-2.0.3.dmg",
  },
  TrackpadGuard: {
    label: "TrackpadGuard Mac",
    repo: "TrackpadGuard",
    assetPattern: /\.dmg$/i,
    fallbackUrl: "https://github.com/armsone/TrackpadGuard/releases/download/v2.0.6/TrackpadGuard-2.0.6.dmg",
  },
  WhattoEat: {
    label: "오늘 뭐 먹지?? Mac",
    repo: "WhattoEat",
