...
export const RELEASE_DOWNLOADS: Record<DownloadKey, ReleaseDownload> = {
  "NasFinder-Android": {
    ...
    assetPattern: /\.apk$/i,
    fallbackUrl: "https://github.com/armsone/NasFinder-Android/releases/download/android-v2.2.0/NasFinder-Android-2.2.0.apk",
  },
  "NasFinder-Super-Thumbnail": {
  ...
  "S.tand-Android": {
    ...
    repo: "S.tand-Android",
    assetPattern: /\.apk$/i,
    fallbackUrl: "https://github.com/armsone/S.tand-Android/releases/download/android-v2.2.1/S.tand-Android-2.2.1.apk",
  },
  CCMB: {
    label: "CCMB Mac",
    repo: "CCMB",
  ...
  "WhattoEat-Android": {
    ...
    fallbackUrl: "https://github.com/armsone/WhattoEat-Android/releases/download/android-v0.4.1/WhattoEat-Android-0.4.1.apk",
  },
  "button-Android": {
    label: "버튼 Android",
    repo: "button-Android",
