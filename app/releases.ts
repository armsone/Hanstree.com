...
export const RELEASE_DOWNLOADS: Record<DownloadKey, ReleaseDownload> = {
  ...
  "S.tand-macOS": {
    ...
    fallbackUrl: "https://github.com/armsone/S.tand/releases/download/macos-v2.3.0/S.tand-macOS-2.3.0.dmg",
  },
  "S.tand-Android": {
    label: "S.tand Android",
    repo: "S.tand-Android",
    assetPattern: /\.apk$/i,
    fallbackUrl: "https://github.com/armsone/S.tand-Android/releases/download/android-v2.3.4/S.tand-Android-2.3.4.apk",
  },
  CCMB: {
    label: "CCMB Mac",
    repo: "CCMB",
    assetPattern: /\.dmg$/i,
    fallbackUrl: "https://github.com/armsone/CCMB/releases/download/v2.0.9/CCMB-2.0.9.dmg",
  },
  BTN: {
    label: "BTN Mac",
    repo: "BTN",
  ...
  "StarManager-Android": {
    ...
    assetPattern: /^StarManager-Android-2\.4\.0\.apk$/i,
    fallbackUrl: "https://github.com/armsone/StarManager-Android/releases/download/android-v2.4.0/StarManager-Android-2.4.0.apk",
  },
  "HtOMS-BK": {
