...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "터미널을 열지 않고도 Codex의 남은 주간 사용량·크레딧, Claude·Gemini의 세션·주간 사용량, Grok의 요금제·월간 크레딧과 이 Mac 기록 기반 24시간 토큰 추정치를 함께 확인하는 비공식 macOS 메뉴 막대 앱입니다.",
    theme: "blue",
    artwork: "menubar",
    platforms: [
      { name: "macOS", status: "공개", detail: "v0.4.3 · macOS 10.15+ · Universal", url: "https://github.com/armsone/CCMB/releases/tag/v0.4.3", downloadLabel: "DMG 다운로드", checksum: "1b6d2fc19e0523b748321d80b1c30e79efcc946cd14d1bfc1d87eac4fa0bc714" },
    ],
    features: [
      { title: "네 AI를 한눈에", body: "Codex·Claude·Gemini·Grok의 사용량을 통일된 4열 링과 패널로 나란히 확인합니다." },
      { title: "추정임을 밝히는 Grok 사용량", body: "Grok이 실시간 잔량을 제공하지 않는 Free 계정에서는 이 Mac의 최근 Grok CLI 완료 기록을 합산해 24시간 토큰 사용량·남은 비율·회복 시각을 추정하고, 화면에 ‘추정’이라고 명확히 표시합니다." },
    ...
    guide: [
      ...
      { title: "표시와 새로고침", body: "메뉴 막대 값과 상세 정보, Grok의 24시간 토큰 추정치, 패널 배경 불투명도와 자동 새로고침 간격을 확인·설정합니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Grok 24시간 토큰 추정", body: "이 Mac의 최근 Grok CLI 완료 기록을 기준으로 사용량·남은 비율·회복 시각을 추정하고 추정값임을 명시" },
    ...
    privacy: [
      ...
      "Grok 24시간 추정에는 이 Mac의 Grok CLI 완료 기록에 포함된 시각과 토큰 합계만 사용하며, 질문이나 응답 내용은 보관하거나 공개하지 않습니다. Grok 웹과 다른 기기에서 사용한 양은 추정에 포함되지 않습니다.",
  ...
  },
  {
    ...
    summary: "가족 기기를 QR로 묶고 조용한 알림·띵동 알림·목소리 전달과 긴급 사이렌을 보내는 iPhone·Android 가족 호출 앱입니다. 가까운 기기는 직접 연결하고, 개인 NAS가 iPhone의 APNs와 Android의 FCM을 함께 중계합니다.",
    theme: "coral",
    icon: "/apps/button/icon.png",
    artwork: "phones",
    platforms: [
      { name: "iPhone", status: "완료", detail: "1.1 (16) · iOS 17+", availabilityNote: "TestFlight 업로드 완료" },
      {
        name: "Android",
        status: "공개",
        detail: "1.1.3 (17) · Android 8.0+",
        url: "https://github.com/armsone/button-Android/releases/download/v1.1.3/Button-Android-v1.1.3-build17.apk",
        downloadLabel: "Android APK 바로 받기",
        checksum: "9519793f5fcb774a74eae83fddf06f6cfde46d6e06bd973aa7ef6fea4a54d03f",
      },
    ],
    features: [
      { title: "조용함에서 사이렌까지", body: "조용히 알림은 탭하면 소리 없이 전해지고, 5초간 누르면 보낸 기기는 조용한 채 상대 기기에 강력한 사이렌을 보냅니다." },
      { title: "누르고 말하면 바로 전달", body: "부모가 목소리 전달 버튼을 누르면 즉시 녹음되고 손을 떼면 전송됩니다. 받는 사람은 앱에 들어오면 바로 듣고 최근 기록에서 다시 들을 수 있습니다." },
      { title: "한 사람 또는 모두에게", body: "우리 공간 목록에서 한 사람을 선택해 보내거나 선택 없이 가족 모두를 한 번에 부릅니다." },
    ...
    guide: [
      { title: "공간 만들기", body: "한 기기에서 우리 공간을 만들고 표시된 QR 코드를 가족 기기에서 스캔합니다." },
      { title: "이름과 역할 정하기", body: "각 기기의 이름을 확인하고 부모 또는 자녀 역할을 선택합니다." },
      { title: "받을 사람 선택", body: "모두에게 보내려면 선택하지 않고, 한 사람에게만 보내려면 우리 공간 목록에서 이름을 누릅니다." },
      { title: "호출 보내기", body: "조용히 알림이나 띵동 알림을 누릅니다. 조용히 알림을 5초간 누르면 사이렌을 보내고, 부모는 목소리 전달을 누른 채 말한 뒤 손을 떼어 바로 전송합니다." },
