...
const appCatalog: AppData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "한 번 보내고, 진행은 분명하게", body: "2.6.4는 사진 첨부와 실제 생성 시작을 구분해 확인하고, 이미 보낸 요청을 반복 전송하지 않습니다. 작업 화면 끝에도 여유를 두어 마지막 항목을 편하게 볼 수 있습니다.", icon: "/apps/starmanager/features/feature-06.webp" },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "완성된 답만 정확히 한 번", body: "사진 첨부와 실제 생성 시작을 확인합니다. 전송 버튼은 한 번만 누르고 이후에는 상태를 관찰해, 안정된 최종 결과만 앱에 한 번 반영합니다.", icon: "/apps/aibi/features/feature-03.webp" },
