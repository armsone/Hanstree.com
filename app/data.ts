...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    platforms: [
      {
        name: "macOS",
        status: "공개",
        detail: "2.1.1 (202608251305) · macOS 14+ · Apple Silicon·Intel · Apple 공증 완료",
        url: releaseDownloadPath("NasFinder-Super-Thumbnail"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "2001bc1f65066316a5455a0c3c48564ac401afec0a050cb2c1d9a1e94e296871",
      },
    ],
    features: [
      ...
      { title: "만들어진 썸네일 바로 확인", body: "선택한 폴더의 기존 썸네일과 새로 만들어지는 결과를 앱 안에서 보고, 휴대폰처럼 미리보기 영역을 접거나 펼칠 수 있습니다. 다음 업데이트에서는 새로 만든 항목이 가장 왼쪽에 오는 겹침형 가로 미리보기를 제공합니다." },
      { title: "중단 후 이어서", body: "이미 만든 썸네일은 건너뛰고 다시 검사하므로 긴 작업을 멈췄다가 안전하게 이어갈 수 있습니다." },
      { title: "원본은 그대로, 썸네일만 새로", body: "새로하기는 선택한 폴더 아래의 .NasFinder-Vault만 확인 후 지우고 다시 만듭니다. 사진과 영상 원본은 삭제하지 않습니다. 다음 업데이트에서는 보관본을 찾을 때부터 삭제 완료 개수까지 큰 진행 막대로 보여줍니다." },
    ...
    progress: [
      ...
      { state: "active", title: "정리 진행과 미리보기 개선", body: "보관본 탐색·삭제 진행 막대와 최신 항목이 왼쪽에 오는 iPhone형 가로 미리보기를 다음 업데이트용으로 검증 완료" },
