...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "만들어진 썸네일 바로 확인", body: "선택한 폴더의 기존 썸네일과 새로 만들어지는 결과를 앱 안에서 보고, 휴대폰처럼 미리보기 영역을 접거나 펼칠 수 있습니다." },
      { title: "중단 후 이어서", body: "이미 만든 썸네일은 건너뛰고 다시 검사하므로 긴 작업을 멈췄다가 안전하게 이어갈 수 있습니다." },
      { title: "원본은 그대로, 썸네일만 새로", body: "새로하기는 선택한 폴더 아래의 .NasFinder-Vault만 확인 후 지우고 다시 만듭니다. 사진과 영상 원본은 삭제하지 않습니다." },
