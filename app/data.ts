...
export const apps: AppData[] = [
  {
    ...
    features: [
      ...
      { title: "Super Thumbnail과 미디어 미리보기", body: "Mac용 Super Thumbnail이 준비한 수퍼썸네일로 큰 보관함을 빠르게 훑고, 전체화면 미리보기에서 사진과 영상을 확인합니다. Android의 NAS Vault 복원과 제스처 보완판은 실기기 검증 중입니다." },
    ...
    progress: [
      ...
      { state: "active", title: "Android 수퍼썸네일·미디어 보기 재검증", body: "NAS Vault 복원과 영상 볼륨·탐색·닫기 제스처 보완판을 실제 NAS와 Android 기기에서 검증한 뒤 다음 공개판에 반영" },
    ],
    screenshots: [
