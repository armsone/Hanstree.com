...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "가족 기기를 QR로 묶고 조용한 알림·띵동 알림·목소리 전달을 보내는 iPhone·Android 가족 호출 앱입니다. 가까운 기기는 직접 연결하고, 개인 NAS가 iPhone의 APNs와 Android의 FCM을 함께 중계합니다.",
    theme: "coral",
    ...
    features: [
      { title: "세 가지 호출", body: "조용히 알림, 세 번 울리는 띵동 알림, 녹음한 목소리 전달 중 상황에 맞는 방식을 고릅니다." },
    ...
    guide: [
      ...
      { title: "호출 보내기", body: "조용히 알림이나 띵동 알림을 누릅니다. 부모 역할은 목소리를 녹음한 뒤 전달할 수도 있습니다." },
