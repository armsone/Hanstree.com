...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    platforms: [
      {
        name: "iPhone · iPad",
        status: "준비 중",
        detail: "0.1.0 (202608290159) · iOS·iPadOS 17+",
        availabilityNote: "공개 테스트 제공 상태 확인 후 설치 경로 안내 예정",
      },
    ],
    features: [
      { title: "한 벌을 최대 30장의 디테일로", body: "전체 실루엣부터 패치, 레드탭, 버튼, 봉제와 케어라벨까지 자유롭게 촬영하거나 보관함에서 고릅니다. 길게 눌러 중요한 순서로 바꾸고 한 번에 모두 비울 수 있습니다." },
      { title: "한양이 비슷한 사진을 먼저 정리", body: "원본 30장은 그대로 두고, 한양이 겹치는 구도와 품질을 살펴 분석에 도움 되는 사진을 최대 20장으로 추립니다." },
      { title: "아이비로 이어지는 ChatGPT 감정", body: "별도 API 키 없이 사용자가 공식 ChatGPT 화면에서 직접 로그인한 웹 세션을 활용합니다. 로그인이 필요하면 앱 안에서 안내하고, 완료된 분석 결과만 데님덱스로 가져옵니다." },
    ...
    progress: [
      ...
      { state: "active", title: "iPhone·iPad 공개 테스트 준비", body: "0.1.0 build 202608290159의 공개 제공 상태를 확인 중이며, 확정 뒤 설치 경로를 안내할 예정" },
