...
export const apps: AppData[] = [
  {
    ...
    features: [
      ...
      { title: "로고 대신 내용이 보이는 Super Thumbnail", body: "영상 전체 길이의 3/13 지점을 먼저 고르고, 화면 절반 이상이 검을 때만 6/13 지점을 한 번 더 확인합니다. 폴더는 최대 9칸으로 모으며 1.5pt 블러를 딱 한 번만 적용합니다. NAS Vault에 준비된 결과가 있으면 일반 썸네일보다 먼저 보여줍니다." },
      { title: "즐겨찾기도 한눈에, 원하는 순서대로", body: "Android 즐겨찾기에서 NAS·OneDrive·Google Drive의 이전 항목까지 썸네일을 되찾아 보여줍니다. 길게 눌러 제거하고 드래그해 자주 쓰는 순서로 바꿀 수 있습니다." },
    ...
    progress: [
      ...
      { state: "active", title: "iPhone·iPad·Mac 2.2.0 Public Beta", body: "build 202608252025 처리 완료 · 기존 내부 그룹 배포 · 10,000명 공개 링크 생성 · 외부 베타 심사 대기 중" },
