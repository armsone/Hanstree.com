...
const appCatalog: AppData[] = [
  {
    ...
    summary: "아이디어가 떠오를 때마다 어디서든 브라우저를 열어 맡기고 싶다면. Hanstree-AI는 내 NAS에 둔 AI 작업실입니다. 아이디어마다 프로젝트를 만들고, AI 팀장에게 말로 요청하면 진행과 결과가 차곡차곡 쌓입니다. 0.3.68에서는 마스터가 프로젝트 소유자를 바꾸고, 프로젝트를 오가도 펼친 목록을 이어서 볼 수 있습니다. 긴 목록은 스크롤할 수 있으며 스크롤 막대는 화면에서 감췄습니다. 소유자가 허용한 계정으로 사용하는 비공개 작업실입니다.",
    theme: "violet",
    ...
    platforms: [
      {
        name: "Web · 개인용 웹 작업실",
        status: "개발 중",
        detail: "0.3.68 · 허용된 계정으로 이용 · NAS에서 실행",
    ...
    features: [
      ...
      { title: "진행과 결과", body: "브라우저를 닫아도 서버가 작업을 이어가고, 돌아오면 대화에서 진행과 결과를 확인합니다.", icon: "/apps/super-thumbnail/features/feature-08.webp" },
    ...
    progress: [
      ...
      { state: "done", title: "0.3.68 NAS 반영·소스 릴리즈", body: "NAS 실행본과 릴리즈 소스의 일치를 확인했습니다. 마스터의 프로젝트 관리 메뉴에서 이름·삭제·소유자 변경을 확인했고, 프로젝트를 전환해도 펼친 목록이 유지되며 숨김 스크롤 막대 상태에서도 목록을 스크롤할 수 있음을 운영 화면에서 확인했습니다. 전체 기능을 재검증한 것은 아닙니다." },
