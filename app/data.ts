...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "AI·개발 작업 뒤 남은 시뮬레이터·작업 산출물과 유휴 개발 프로세스를 찾아 위험도와 이유를 설명하고, 사용자가 고른 항목만 다시 확인한 뒤 정리하는 macOS 메뉴 막대 앱입니다.",
    theme: "blue",
    ...
    platforms: [
      {
        name: "macOS",
        status: "공개",
        detail: "v1.2.0 · macOS 13+ · Universal · Apple 공증 완료",
        url: "https://github.com/armsone/BackToNormal/releases/download/v1.2.0/BackToNormal-1.2.0.dmg",
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "5dbc1e7fd851c30cd56ca5b4b0e5ba9636ae35ea4952248e2cb43e5adff886c8",
      },
    ],
    features: [
      ...
      { title: "유휴 프로세스 메모리 회수", body: "엄격한 유휴 조건을 충족한 Gradle·Kotlin 데몬, 테스트 러너, 브라우저 자동화와 개발 서버만 종료 후보로 제안합니다." },
    ...
    progress: [
      ...
      { state: "done", title: "서명·공증 DMG 공개", body: "Developer ID 서명과 Apple 공증을 마친 v1.2.0 Universal DMG를 GitHub Releases에 공개" },
    ...
    privacy: [
      ...
      "선택한 파일은 우선 macOS 휴지통으로 이동하며, 시뮬레이터처럼 복구할 수 없는 조치는 실행 전에 별도로 알립니다.",
