...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    artwork: "phones",
    platforms: [
      { name: "iPhone · iPad", status: "TestFlight", detail: "2.1.0 · 빌드 202608271625 · iOS·iPadOS 18+", availabilityNote: "2.1.0 Public Beta 심사 대기 · 공개 링크에서는 승인된 2.0.0 테스트 가능" },
      {
        name: "Android",
        status: "공개",
        detail: "2.1.0 · 빌드 202608271625 · 내부 코드 343705 · Android 8.0+",
        url: releaseDownloadPath("StarManager-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "c7489c0fe0e36f4dd6411577d6090986054ba4aa729943021ad26d38ea264b78",
    ...
    features: [
      ...
      { title: "앱 안에서 쓰는 외부 AI", body: "ChatGPT·Gemini·Claude 로그인 페이지를 앱 안에서 열고, 한 번 로그인한 세션을 기기에 유지한 채 작성부터 전송까지 이어갑니다." },
      { title: "결과를 안정적으로 가져오기", body: "외부 AI에 질문을 자동으로 채우고 전송한 뒤 완성된 답변을 감지해 스타메니저 초안으로 가져옵니다." },
    ...
    guide: [
      ...
      { title: "AI로 초안 만들기", body: "Gemini·ChatGPT·Claude·기기 AI 중 하나를 고른 뒤 해당 만들기 버튼을 누릅니다. 외부 AI는 앱 안의 브라우저에서 자동 입력·전송됩니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Android 2.1.0 공개", body: "제품 2.1.0 · 빌드 202608271625 · 내부 코드 343705의 휴대전화·태블릿·Google TV 지원 APK를 GitHub Releases에 공개" },
      { state: "done", title: "iPhone 실기기 설치", body: "대표 iPhone에 0.1.0 (1) 설치와 실행 확인" },
      { state: "active", title: "iOS·iPadOS 2.1.0 Public Beta 심사", body: "build 202608271625를 Public Beta 그룹에 추가해 Apple 심사를 기다리는 중이며 기존 2.0.0 공개 테스트 링크는 유지" },
