...
export const apps: AppData[] = [
  {
    ...
    platforms: [
      ...
      { name: "Mac용 NasFinder", status: "TestFlight", detail: "2.2.0 · Apple Silicon · iPhone·iPad 호환 앱", availabilityNote: "같은 TestFlight 빌드 · 2배 Mac 보기 · 공개 테스트 심사 중" },
      {
        name: "Android",
        status: "공개",
        detail: "2.2.0 · 빌드 202608252025 · 내부 코드 341065 · Android 8.0+",
        url: releaseDownloadPath("NasFinder-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "1f865fb335695d6d906cc14b5919e80bb2d7e24bf99b11dbe0a629a85b7391af",
        availabilityNote: "SM-F968N 데이터 유지 교체 설치 · 버튼과 뒤로가기 즉시 반응 확인",
      },
    ],
    features: [
    ...
    progress: [
      ...
      { state: "done", title: "Android 2.2.0 공개", body: "제품 2.2.0 · 빌드 202608252025 · 내부 코드 341065의 서명 APK를 GitHub Releases에 공개하고 실기기 반응 확인" },
