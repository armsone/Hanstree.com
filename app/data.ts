...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    artwork: "clock",
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.2.1 (202608261617) · 내부 build 342257 · iOS·iPadOS 17+", availabilityNote: "Public Beta 심사 제출 · Apple 심사 대기 중" },
      {
        name: "macOS",
        status: "공개",
        detail: "2.2.1 (202608261617) · macOS 14+ · Apple 공증 완료",
        url: releaseDownloadPath("S.tand-macOS"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "fa898788601219fb5072e8cfa25a0df71de684a02774fd7a31d77a31c7017ee4",
      },
      {
        name: "Android · Google TV",
        status: "공개",
        detail: "2.2.4 · 빌드 202608271748 · 내부 코드 343788 · Android 8.0+",
        url: releaseDownloadPath("S.tand-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "28b5dc4c1d98e1d67972a3ed3086da8f9eacea70877c47726e780f52997280ad",
        availabilityNote: "Google TV에서 초 표시를 분 카드 바로 아래에 두고 오른쪽 끝을 맞춰 겹치지 않게 정리 · Google TV 실기기 화면 검증은 미실행",
      },
    ],
    features: [
      ...
      { title: "Google TV 리모컨 지원", body: "TV 앱 목록의 S.tand 배너에서 바로 실행하고, 10-foot 가로 화면에서 D-pad로 음악·설정·테마·밝기·시계 크기와 최신 버전 확인을 조작합니다. TV에는 음악·시계·날씨에 필요한 기능만 남겼습니다." },
    ...
    guide: [
      ...
      { title: "Google TV에서", body: "TV 앱 목록에서 S.tand 배너를 고른 뒤 방향키와 가운데 선택 버튼으로 음악, 설정, 테마, 밝기와 시계 크기를 조작합니다. 가운데 로고를 선택하면 최신 공개판도 확인할 수 있습니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Android·Google TV 2.2.4 공개", body: "초 표시를 분 카드 바로 아래에 두고 오른쪽 끝을 맞춰 겹치지 않게 정리한 빌드 202608271748 · 내부 코드 343788 APK를 공개 · Google TV 실기기 화면 검증은 미실행" },
