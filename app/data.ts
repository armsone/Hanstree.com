...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "같은 공간의 가족 기기를 QR로 묶고 조용한 알림·띵동 알림·목소리 전달을 보내며, 원거리에서는 개인 NAS와 Apple 푸시 알림으로 호출을 이어주는 iPhone용 가족 호출 앱입니다.",
    theme: "coral",
    ...
    features: [
      ...
      { title: "화면을 닫아도 수신", body: "Apple 푸시 알림을 사용해 앱이 화면에 없거나 잠겨 있을 때도 호출 알림과 소리를 전달합니다." },
      { title: "근거리 연결과 원거리 중계", body: "가까운 기기는 직접 연결하고, 떨어진 가족에게는 개인 Synology NAS 중계 서버를 통해 같은 호출을 보냅니다." },
    ...
    guide: [
      ...
      { title: "알림 권한 확인", body: "잠금 화면에서도 받으려면 iPhone 설정에서 버튼 앱의 알림과 소리를 허용합니다." },
    ],
    progress: [
    ...
    github: ["https://github.com/armsone/button"],
    privacy: [
      "가족 공간 식별자, 기기 이름과 역할은 호출 연결을 위해 기기와 사용자가 지정한 개인 중계 서버에서 처리합니다.",
      "푸시 알림용 기기 토큰은 해당 가족 공간의 원거리 호출 전달에만 사용합니다.",
