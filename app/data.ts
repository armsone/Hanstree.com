...
export const apps: AppData[] = [
    ...
    platforms: [
      {
        name: "macOS",
        status: "공개",
        detail: "2.3.1 (202608270910) · macOS 14+ · Apple Silicon·Intel · Developer ID 서명·Apple 공증 완료",
        url: releaseDownloadPath("NasFinder-Super-Thumbnail"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "03ef06e868ad3308ce5389be27ff46ee097443bb9be793f2daf0212ea1c26962",
      },
    ],
    features: [
  ...
  },
  {
    ...
    artwork: "clock",
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.3.0 (202608282116) · iOS·iPadOS 17+", availabilityNote: "App Store Connect 처리 완료 · 내부 테스트 연결 · Public Beta 연결 확인 대기" },
      {
        name: "macOS",
        status: "공개",
  ...
  },
  {
    ...
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.0.0 (202608230737) · iOS·iPadOS 17+", availabilityNote: "내부 테스트 전용 빌드 · 외부용 새 빌드 필요" },
      {
        name: "Android · Google TV",
        status: "공개",
        detail: "2.1.0 · 빌드 202608251843 · 내부 코드 340964 · Android 8.0+",
        url: releaseDownloadPath("HtOMS-BK"),
        downloadLabel: "Android용 APK 다운로드",
        checksum: "5e1d5176f617dcae13d4d8c4e018af6d2416508e59a177d183bf5b51d780555d",
        availabilityNote: "서명 APK 재다운로드·무결성 검증 완료 · 연결된 Android 실기기 없음",
      },
    ],
    features: [
    ...
    progress: [
      ...
      { state: "done", title: "Android 2.1.0 공개", body: "제품 2.1.0 · 빌드 202608251843 · 내부 코드 340964의 서명 APK와 SHA-256 체크섬을 GitHub Releases에 공개" },
  ...
  },
  {
    ...
    platforms: [
      { name: "iPhone · iPad", status: "TestFlight", detail: "2.4.0 · 빌드 202608290628 · iOS·iPadOS 18+", availabilityNote: "2.4.0 Public Beta 심사 대기 · 공개 링크에서는 승인된 이전 빌드 테스트 가능" },
      {
        name: "Android",
        status: "공개",
        detail: "2.4.0 · 빌드 202608290628 · 내부 코드 345988 · Android 8.0+",
        url: releaseDownloadPath("StarManager-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "6db661ea5b0a78aa469406817fbfa6262205b5ea7b610e97e6ffcf0f06d99366",
  ...
  },
  {
    ...
    platforms: [
      {
        name: "iPhone · iPad",
        status: "TestFlight",
        detail: "0.2.0 (202608291019) · iOS·iPadOS 17+ · 외부 베타 심사 대기 중",
        availabilityNote: "제품 정보·연대·제조공장·희귀도·적정 매입가 빌드를 내부·외부 그룹에 연결 완료 · 내부 테스터 1명 · Public Beta는 Apple 승인 뒤 참여 가능",
      },
    ],
    features: [
    ...
    progress: [
      ...
      { state: "active", title: "iPhone·iPad 0.2.0 Public Beta 심사", body: "제품 정보, 추정 생산연도·제조공장, 보수적 희귀도와 한국·일본 적정 매입가를 담은 build 202608291019를 Internal과 Public Beta 그룹에 연결하고 심사에 제출했습니다. 내부 테스터는 현재 1명이며 외부 공개 링크는 Apple 승인 뒤 참여할 수 있습니다." },
  ...
  },
  {
    ...
    platforms: [
      {
        ...
        status: "완료",
        detail: "AIBI 0.4.3 · Apple·Android 이식·빌드·동기화 검증 완료",
    ...
    features: [
      ...
      { title: "사진 1~8장을 순서대로", body: "사진만 또는 사진과 글을 함께 전달하고, 고른 사진은 순서를 유지한 채 제공자별 첨부 흐름으로 보냅니다. 긴 변 2,048px·장당 2MB 안으로 자동 정리합니다." },
    ...
    progress: [
      { state: "done", title: "독립 기준 프로젝트 0.4.3", body: "공통 계약, 제공자 변화 대응 절차, Apple·Android 참조 엔진과 StarManager 배포 스냅샷을 독립 기준 원본으로 구성" },
