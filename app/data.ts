...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    artwork: "clock",
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.4.0 (202608301000) · iOS·iPadOS 17+", availabilityNote: "새 빌드 Public Beta 심사 대기 · 기존 공개 링크로 참여 가능" },
      {
        name: "macOS",
        status: "공개",
        detail: "2.4.0 (202608301000) · macOS 14+ · Apple 공증 완료",
        url: releaseDownloadPath("S.tand-macOS"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "5fd91e504eff5bb1e87b72248f961c2ace7742444f33c520b50a85b212711f92",
      },
      {
        name: "Android · Google TV",
        status: "공개",
        detail: "2.4.0 · 빌드 202608301000 · 내부 코드 347640 · Android 8.0+",
        url: releaseDownloadPath("S.tand-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "80b79eb3a9d6dd405d97da2577fb9426e99ba74b949bd9dc6a3d450ddd9ca337",
        availabilityNote: "Android·Google TV용 2.4.0 APK 공개 · 폴드·트라이폴드에서 화면 잠금 뒤 매이트 감지 유지 확인",
      },
    ],
    features: [
