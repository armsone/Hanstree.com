...
export const apps: AppData[] = [
  {
    ...
    platforms: [
      ...
      { name: "Mac용 NasFinder", status: "완료", detail: "Apple Silicon · iPhone·iPad 호환 앱", availabilityNote: "같은 TestFlight 빌드로 설치" },
      {
        name: "Android",
        status: "공개",
        detail: "1.1 · APK v6 · Android 8.0+",
        url: "https://github.com/armsone/NasFinder-Android/releases/download/android-v6/NasFinder-Android-v6.apk",
        downloadLabel: "Android APK 바로 받기",
        checksum: "7841018458ed575862a509707a15171c5175937b91c50292b5b7396421323736",
      },
    ],
    features: [
    ...
    progress: [
      ...
      { state: "done", title: "Android 공개", body: "NasFinder Android v6 APK를 GitHub Releases에 공개" },
    ],
    screenshots: [
  ...
  },
  {
    ...
    summary: "터미널을 열지 않고도 Codex의 남은 주간 사용량·크레딧과 Claude·Gemini의 세션·주간 사용량을 함께 확인하는 비공식 macOS 메뉴 막대 앱입니다.",
    theme: "blue",
    artwork: "menubar",
    platforms: [
    ...
    screenshots: [
      ...
      { src: "/apps/ccmb/screens/ccmb-usage-menu.png", alt: "Codex·Claude·Gemini 사용량 링과 갱신 그래프를 나란히 표시한 CCMB 메뉴", layout: "menu" },
    ],
