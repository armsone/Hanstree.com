    ...
    platforms: [
      {
        name: "macOS",
        status: "공개",
        detail: "2.1.2 (202608251551) · macOS 14+ · Apple Silicon·Intel · Apple 공증 완료",
        url: releaseDownloadPath("NasFinder-Super-Thumbnail"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "5649c0b6e787da779799046929cabf7aa10727fbefee30fe3f70dc7b9b81b3e7",
      },
    ],
    features: [
      ...
      { title: "만들어진 썸네일 바로 확인", body: "선택한 폴더의 기존 썸네일과 새로 만들어지는 결과를 앱 안에서 보고, 휴대폰처럼 미리보기 영역을 접거나 펼칠 수 있습니다. 2.1.2는 새로 만든 항목이 가장 왼쪽에 오는 겹침형 가로 미리보기를 제공합니다." },
