  ...
  },
  {
    ...
    platforms: [
      ...
      { name: "Mac", status: "TestFlight", detail: "2.0.0 · Apple Silicon · iPad 앱 호환 모드", availabilityNote: "같은 TestFlight 빌드 · 처리 완료" },
      {
        ...
        availabilityNote: "현재 공개 APK는 기존판 · AiShot 동일 미디어 분석의 Android 실행 동등성은 검증 중",
      },
    ],
    features: [
    ...
    progress: [
      ...
      { state: "active", title: "Android AiShot 동일 원본 검증", body: "같은 스윙 영상과 같은 프레임 구간으로 분석 입력·자세 판정·대체 경로·결과 저장을 단계별 비교 중" },
