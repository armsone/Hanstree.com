...
export const apps: AppData[] = [
  {
    ...
    artwork: "files",
    platforms: [
      { name: "iPhone · iPad", status: "TestFlight", detail: "2.2.0 (202608252025) · iOS·iPadOS 17+", availabilityNote: "TestFlight 업로드 완료 · Apple 처리 중" },
      { name: "Mac용 NasFinder", status: "TestFlight", detail: "2.2.0 · Apple Silicon · iPhone·iPad 호환 앱", availabilityNote: "같은 TestFlight 빌드 · 2배 Mac 보기 · Apple 처리 중" },
      {
        name: "Android",
        status: "공개",
    ...
    progress: [
      ...
      { state: "active", title: "iPhone·iPad·Mac 2.2.0 업로드", body: "build 202608252025 TestFlight 업로드 완료 · Apple 처리 중" },
  ...
  },
  {
    ...
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.1.0 (202608251027) · 내부 build 340467 · iOS·iPadOS 17+", availabilityNote: "TestFlight 처리 완료" },
      {
        name: "macOS",
        status: "공개",
        detail: "2.1.0 (202608251027) · macOS 14+ · Apple 공증 완료",
  ...
  },
  {
    ...
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.0.0 (202608230737) · iOS·iPadOS 17+", availabilityNote: "TestFlight 처리 완료" },
      {
        name: "Android · Google TV",
        status: "공개",
        detail: "2.0.0 · 빌드 202608251115 · 내부 코드 340515 · Android 8.0+",
    ...
    progress: [
      ...
      { state: "done", title: "Android 2.0.0 공개", body: "제품 2.0.0 · 빌드 202608251115 · 내부 코드 340515의 설치·실행 검증 APK와 SHA-256 체크섬을 GitHub Releases에 공개" },
