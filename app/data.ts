...
const appCatalog: AppData[] = [
  {
    ...
    name: "Hanstree-AI",
    english: "Hanstree-AI",
    eyebrow: "YOUR NAS · YOUR WORKROOM",
    tagline: "떠오른 생각을, 팀장에게 말로.",
    summary: "사진을 첨부해 요청하고, 만든 이미지를 대화에서 바로 확인하세요. Hanstree-AI는 내 NAS에 둔 AI 작업실입니다. 0.3.72에서는 생성 이미지의 원본을 열고, 로그인 없이 볼 수 있는 링크로 나눌 수 있습니다. 이미지는 생성 완료부터 7일간 보관합니다. 아이디어마다 프로젝트를 만들어 AI 팀장에게 맡기는, 소유자가 허용한 계정으로 쓰는 비공개 작업실입니다.",
    theme: "violet",
    icon: "/apps/hanstree-workroom/icon-019.png",
    heroImage: "/apps/hanstree-workroom/icon-019.png",
    screenshots: [{ src: "/apps/hanstree-workroom/screens/login-019.png", alt: "Hanstree-AI 실제 NAS 로그인 화면 · 0.1.9 촬영", layout: "phone" }],
    artwork: "bridge",
    platforms: [
      {
        name: "Web · 개인용 웹 작업실",
        status: "개발 중",
        detail: "0.3.72 · 허용된 계정으로 이용 · NAS에서 실행",
        url: "https://hanstree.synology.me:5443",
        downloadLabel: "작업실 열기",
        availabilityNote: "소유자가 허용한 계정 필요 · 공개 회원가입·설치 파일·TestFlight 없음",
      },
    ],
    features: [
      { title: "만든 이미지를 바로 보고 공유", body: "사진을 첨부해 요청하고 생성된 이미지를 대화에서 바로 확인합니다. ‘원본 보기’로 크게 열고 ‘링크 복사’로 나눌 수 있습니다. 공유 주소를 아는 사람은 해당 이미지 한 장을 로그인 없이 열 수 있으며, 생성 완료부터 7일 뒤에는 링크가 만료됩니다.", icon: "/apps/super-thumbnail/features/feature-08.webp" },
      { title: "길어진 목록도 편하게", body: "왼쪽 프로젝트 목록이 화면보다 길어져도 스크롤 막대 없이 스크롤해 끝까지 볼 수 있습니다. 터치로 목록을 넘기고, 길게 눌러 순서를 바꿉니다. 프로젝트를 오가도 펼쳐 둔 목록은 그대로 열려 있습니다.", icon: "/apps/trackpadguard/features/feature-05.webp" },
      ...
      { title: "팀장에게 말로 요청", body: "Codex 팀장에게 말하듯 요청합니다. 기본 모델은 GPT-6-Luna, 추론 강도는 low이며 요청할 때 바꿀 수 있습니다. 팀장은 필요하면 NAS에 설치된 Claude와 Gemini를 불러 함께 일합니다.", icon: "/apps/starmanager/features/feature-02.webp" },
      { title: "웹 주소부터 자료 정리까지", body: "웹사이트 주소를 넣으면 Exa로 검색하고 원문을 읽어 요약과 확인을 진행하도록 기본 작업 규칙을 적용했습니다.", icon: "/apps/aibi/features/feature-05.webp" },
      { title: "이전 요청을 다시 이어가기", body: "대화의 ‘다시 요청’을 누르면 내용을 입력창에 넣고 같은 텍스트를 클립보드에도 복사합니다. 필요한 부분을 고친 뒤 직접 보낼 수 있습니다.", icon: "/apps/ccmb/features/feature-01.webp" },
      { title: "마스터의 작업실 자체 관리", body: "마스터 전용 ‘놀이터 관리’에서 작업실의 모델·검색·공유 도구·앱 소스·실행 설정을 관리합니다. 일반 프로젝트와 관리 대화를 구분하며, DSM이나 다른 프로젝트의 관리를 위한 기능은 아닙니다.", icon: "/apps/nasfinder/features/feature-08.webp" },
      { title: "프로젝트 소유자 변경", body: "마스터는 프로젝트 이름 옆 관리 메뉴에서 삭제·이름 변경과 함께 소유자를 바꿀 수 있습니다. 프로젝트별 소유자와 허용된 계정으로 접근을 관리합니다.", icon: "/apps/nasfinder/features/feature-08.webp" },
      { title: "진행과 결과", body: "브라우저를 닫아도 서버가 작업을 이어가고, 돌아오면 대화에서 진행과 결과를 확인합니다. 생성 이미지는 7일간 보관하므로 계속 필요한 이미지는 만료 전에 저장해 주세요.", icon: "/apps/super-thumbnail/features/feature-08.webp" },
      ...
      { title: "파일 목록·텍스트 편집·업로드", body: "프로젝트 파일 목록을 보고, 텍스트 파일을 편집하고, 파일을 업로드합니다.", icon: "/apps/aibi/features/feature-05.webp" },
      { title: "밝게·중간·어둡게 테마", body: "화면 밝기를 세 단계 테마로 고릅니다. 로고나 이름을 누르면 새로고침하며, 저장하지 않은 편집이 있으면 먼저 확인합니다.", icon: "/apps/trackpadguard/features/feature-05.webp" },
      { title: "계정별 작업 공간", body: "로그인한 계정과 역할에 따라 볼 수 있는 프로젝트와 관리 기능을 구분합니다. 대화와 파일은 내 NAS에 보관하고, 연결해 둔 AI 계정으로 작업합니다.", icon: "/apps/nasfinder/features/feature-08.webp" },
    ],
    guide: [
      { title: "작업실 열기", body: "브라우저에서 작업실 주소를 열고 소유자가 허용한 계정으로 로그인합니다. 공개 회원가입은 제공하지 않습니다." },
      { title: "프로젝트 만들기", body: "아이디어마다 프로젝트를 만들고 그 안에서 대화를 시작합니다. Mac의 Codex 앱 대화는 자동으로 가져오지 않습니다." },
      { title: "팀장에게 요청", body: "기본 모델로 하고 싶은 일을 적어 보내거나, 모델과 추론 강도를 직접 고릅니다. 웹 주소를 함께 넣어 자료 정리를 맡기고, 대화에서 진행을 확인합니다." },
      { title: "파일과 결과 확인", body: "프로젝트 파일을 보고 텍스트를 편집하거나 업로드합니다. 브라우저를 닫았다가 돌아와 진행과 결과를 확인하고, 주간 잔여량을 보며 다음 요청을 정합니다." },
      { title: "이미지 확인과 공유", body: "대화의 생성 이미지에서 ‘원본 보기’로 크게 확인하거나 ‘링크 복사’로 공유합니다. 링크는 생성 완료부터 7일까지만 열립니다. 계속 필요한 이미지는 그 안에 저장해 주세요." },
    ],
    progress: [
      { state: "done", title: "0.1.0 핵심 흐름 확인", body: "실제 AI의 읽기 전용 응답, 프로젝트 만들기, Codex·Claude·Gemini 세 서비스의 주간 잔여량 실시간 조회를 확인했습니다." },
      { state: "done", title: "0.3.72 NAS 반영·소스 릴리즈", body: "NAS 실행본과 릴리즈 소스의 일치, 생성 이미지 표시, 로그인 없는 공유 이미지 열람과 기존 로그인 보호 유지를 확인했습니다. 7일 만료·자동 삭제 정책은 소스로 검토했으며, 실제 일주일 경과 후 삭제는 아직 관찰하지 않았습니다. 전체 기능을 재검증한 것은 아닙니다." },
      { state: "done", title: "비공개 소스 보관", body: "Mac에서 제품 디자인과 기능을 개발해 NAS에 배포합니다. 소스 아카이브는 GitHub 비공개 저장소에 릴리즈했으며 공개 다운로드 링크는 없습니다. NAS 안에서 만드는 프로젝트·대화·파일은 사용자의 콘텐츠로, 제품 릴리즈와 별개입니다." },
    ...
    privacy: [
      ...
      "생성 이미지의 공유 주소를 아는 사람은 해당 이미지 한 장을 로그인 없이 볼 수 있습니다. 이 주소로 작업실이나 다른 대화·파일에 접근할 수는 없습니다.",
      "생성 이미지는 생성 완료부터 7일 뒤 공유가 중단됩니다. 앱에 저장한 이미지와 확인된 생성 원본은 만료 후 자동 삭제하며, 서버 시작 시와 매분 정리하고 실패하면 다시 시도합니다. 링크를 복사하거나 열어도 기간은 연장되지 않습니다. 참고용으로 첨부한 사진과 대화 기록은 이 자동 삭제 대상에 포함하지 않습니다.",
      "AI 작업을 요청하면 그 작업에 필요한 내용과 자료가 해당 AI 서비스(OpenAI·Anthropic·Google)로 전달되며 각 서비스의 정책이 적용됩니다.",
      "웹 자료를 조사할 때 검색어나 대상 웹 주소가 Exa 등 연결된 검색 서비스로 전달될 수 있습니다.",
      "작업 실행 환경의 완전한 격리는 보장하지 않습니다. 소유자가 신뢰하고 허용한 계정으로 사용하는 비공개 작업실입니다.",
    ],
  },
  {
    slug: "cleanusb",
    ...
    tagline: "파일은 전하고. 흔적은 덜고.",
    summary: "USB를 건넸더니 상대 PC에 .DS_Store 같은 숨은 파일이 잔뜩 보였던 적 있나요? 클린USB는 꺼내기 전에 외장 드라이브의 숨은 보조 파일을 미리 보여주고, 고른 것만 정리한 뒤 메뉴바에서 바로 꺼냅니다. 한국어 화면으로 정리부터 꺼내기까지 이어집니다.",
    theme: "blue",
    icon: "/apps/cleanusb/icon.png",
    heroImage: "/apps/cleanusb/campaign-hero.webp",
    spotlightImage: "/apps/cleanusb/campaign-selection.webp",
    screenshots: [{ src: "/apps/cleanusb/screens/start.png", alt: "CleanUSB 0.1.0 실제 시작 화면 · 외장 드라이브 미연결 상태", layout: "landscape" }],
    artwork: "cleanup",
    ...
    features: [
      { title: "삭제 전에 직접 확인", body: "파일 종류와 용량, 경로를 살펴보고 정리할 항목을 선택합니다. 경로 검색과 Finder에서 보기로 대상을 확인할 수 있습니다.", icon: "/apps/btn/features/feature-03.webp" },
      { title: "자주 남는 보조 파일부터", body: "기본 대상은 .DS_Store와 Thumbs.db입니다. 메타데이터가 들어갈 수 있는 ._ 파일은 안내를 확인한 뒤 별도로 선택합니다.", icon: "/apps/btn/features/feature-05.webp" },
      { title: "메뉴바에서 꺼내기까지", body: "메뉴바에서 정리 창을 열거나 드라이브를 바로 꺼낼 수 있습니다. 작업이 끝나지 않았거나 오류가 있으면 자동 꺼내기를 진행하지 않습니다.", icon: "/apps/cleanusb/icon-v2.webp" },
      { title: "내가 시작할 때만 정리", body: "연결만으로 파일을 지우지 않습니다. 검사 후 선택한 파일을 확인하고 실행하며, 최근 작업 요약 20개는 이 Mac에 보관합니다.", icon: "/apps/trackpadguard/features/feature-05.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "NAS에 넣어 둔 사진과 영상, 클라우드에 흩어진 파일을 지금 손에 든 기기에서 바로 열어 보세요. 나스파인더는 NAS·클라우드·네트워크 장비와 기기 안의 파일을 한곳에서 보고 재생하고, 폰하드에 모아 두거나 Live Photo와 Motion Photo까지 QR로 연결한 다른 기기에 보내는 파일 앱입니다.",
    theme: "violet",
    ...
    features: [
      { title: "여러 저장공간을 한곳에서", body: "Synology, SFTP, SMB, WebDAV, FTP와 Dropbox·OneDrive·Google Drive를 한 앱에서 탐색합니다.", icon: "/apps/nasfinder/features/feature-01.webp" },
      { title: "로고 대신 내용이 보이는 Super Thumbnail", body: "영상의 대표 장면과 폴더 속 사진을 미리보기로 보여 줍니다. NAS에 수퍼썸네일을 준비해 두면 파일 이름만 읽지 않아도 원하는 내용을 찾기 쉽습니다.", icon: "/apps/nasfinder/features/feature-02.webp" },
      { title: "즐겨찾기도 폴더 표지로 한눈에", body: "Android에서는 NAS·OneDrive·Google Drive의 이전 항목까지 썸네일을 되찾아 보여줍니다. iPhone·iPad·Mac은 준비된 폴더 Super Thumbnail을 먼저 보여주고, 없을 때만 폴더 안 미디어 모자이크와 폴더 아이콘 순서로 안전하게 돌아갑니다. 길게 눌러 제거하고 드래그해 원하는 순서로 정리할 수 있습니다.", icon: "/apps/nasfinder/features/feature-03.webp" },
      { title: "움직임과 재생 흐름이 끊기지 않게", body: "움직이는 GIF를 그대로 재생하고 영상 준비 상태를 안내합니다. 재생 화면에서 볼륨도 세밀하게 조절할 수 있습니다.", icon: "/apps/nasfinder/features/feature-04.webp" },
      { title: "민감할 수 있는 썸네일은 기기 안에서 완화", body: "Android에서는 민감할 수 있는 썸네일을 기기 안에서 살펴 부드럽게 처리합니다. 분석 결과와 원본 이미지를 별도 서버로 보내지 않습니다.", icon: "/apps/nasfinder/features/feature-05.webp" },
      { title: "Live Photos & Motion Photos", body: "사진·영상·Live Photo·Motion Photo를 함께 고르고 QR로 연결하면 상대 기기에 맞게 원본을 보존하거나 자동 변환해 사진 보관함에 저장합니다.", icon: "/apps/nasfinder/features/feature-06.webp" },
      { title: "파일 작업을 자연스럽게", body: "연결이 지원하는 범위에서 업로드, 폴더 생성, 이름 변경, 복사·이동·삭제까지 처리합니다.", icon: "/apps/nasfinder/features/feature-07.webp" },
      { title: "기기 안에서 안전하게", body: "Apple 기기는 Keychain, Android는 Keystore로 비밀번호와 로그인 토큰을 보호하고 폰하드 파일과 캐시는 앱 전용 저장공간에 보관합니다.", icon: "/apps/nasfinder/features/feature-08.webp" },
      { title: "폰하드로 모으고 관리", body: "브라우저·네트워크·폰하드로 받은 파일을 기기 안의 한 공간에서 보고 관리합니다. 같은 화면 위에서 서버를 열어 다른 기기의 파일도 받습니다.", icon: "/apps/nasfinder/features/feature-09.webp" },
      { title: "파일 앱에서 바로 가져오기", body: "iPhone·iPad의 파일 앱과 Android 시스템 파일 선택기에서 여러 파일을 골라 폰하드에 안전하게 복사합니다.", icon: "/apps/nasfinder/features/feature-10.webp" },
      { title: "Google Photos에서 직접 선택", body: "iPhone·iPad와 Android용 Google Photos Picker 가져오기 소스가 구현되어 있습니다. 사용자가 직접 고른 사진·영상만 폰하드로 내려받는 흐름이며, 실제 Google 계정 검증이 끝나기 전에는 공개 완료 기능으로 표시하지 않습니다.", icon: "/apps/nasfinder/features/feature-11.webp" },
      { title: "외부 파일 앱과 자연스럽게", body: "iPhone·iPad의 파일 앱과 Android 시스템 파일 탐색기에서 지원 연결을 NasFinder 위치로 열고, 다른 파일 탐색기의 ‘다음으로 열기’에서 받은 파일도 NasFinder의 공통 미디어 보기로 이어지는 소스가 반영되어 있습니다. 다음 공개판 전 기기 검증 중입니다.", icon: "/apps/nasfinder/features/feature-12.webp" },
      { title: "화면에 맞춰 커지는 Overflow", body: "자세히·썸네일·포스터 중 원하는 보기를 고르세요. 넓은 화면의 Overflow에서는 사진을 넘기듯 탐색하고 보기와 배경을 함께 바꿀 수 있습니다.", icon: "/apps/super-thumbnail/features/feature-05.webp" },
      { title: "BK Style과 기기별 아이콘", body: "iPhone·iPad에서는 테마에 어울리는 여섯 가지 앱 아이콘을 고를 수 있습니다. Mac에서는 한 아이콘을 유지하며 테마와 확대 화면을 지원합니다.", icon: "/apps/starmanager/features/feature-08.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "사진과 영상이 가득한 NAS 폴더를 폰에서 열 때마다 미리보기를 기다리는 시간이 아깝다면. 수퍼썸네일은 Finder에 연결한 NAS나 Mac 폴더를 Mac에서 미리 읽어, NasFinder가 바로 쓰는 수퍼썸네일을 한꺼번에 만들어 두는 macOS 전용 앱입니다.",
    theme: "violet",
    ...
    features: [
      { title: "폴더는 차례대로, 파일은 동시에", body: "여러 폴더를 한 번에 작업 대기열에 등록합니다. 폴더 작업은 충돌 없이 차례대로 진행하고, 각 폴더 안의 사진과 영상은 여러 작업자가 동시에 수퍼썸네일로 만듭니다.", icon: "/apps/super-thumbnail/features/feature-01.webp" },
      { title: "원하는 속도, 발열에는 자동 대응", body: "동시에 처리할 파일 수를 정하거나 자동 조절을 켤 수 있습니다. Mac이 뜨거워지면 작업량을 줄이고 식으면 다시 늘립니다.", icon: "/apps/super-thumbnail/features/feature-02.webp" },
      { title: "찾는 동안 발견 수까지", body: "사진·영상과 하위 폴더를 찾는 동안 큰 검색 애니메이션과 진행 막대에 발견한 폴더 수와 파일 수가 실시간으로 나타납니다.", icon: "/apps/super-thumbnail/features/feature-03.webp" },
      { title: "내용을 고르는 대표 장면", body: "영상의 길이에 맞춰 대표 장면을 고르고, 너무 어두운 화면은 다시 확인합니다. 파일명보다 내용을 먼저 알아볼 수 있는 미리보기를 만듭니다.", icon: "/apps/super-thumbnail/features/feature-04.webp" },
      { title: "폴더도 9칸, 흐림은 꼭 필요한 만큼만", body: "폴더 안의 미디어를 최대 아홉 장의 모자이크로 보여 줍니다. 민감할 수 있는 이미지는 필요한 만큼만 부드럽게 처리합니다.", icon: "/apps/super-thumbnail/features/feature-05.webp" },
      { title: "NasFinder와 바로 호환", body: "iPhone·iPad·Mac·Android NasFinder가 읽을 수 있는 JPEG 이름과 .NasFinder-Vault 저장 구조를 사용합니다.", icon: "/apps/super-thumbnail/features/feature-06.webp" },
      { title: "미리보는 재미까지 크게", body: "선택한 폴더의 기존 썸네일과 새로 만들어지는 결과를 앱 안에서 확인합니다. 가로 손잡이를 아래로 끌수록 미리보기와 이미지가 함께 커지고, 고른 크기도 기억합니다. 새로 만든 항목이 가장 왼쪽에 나타납니다.", icon: "/apps/super-thumbnail/features/feature-07.webp" },
      { title: "중단 후 이어서", body: "이미 만든 썸네일은 건너뛰고 다시 검사하므로 긴 작업을 멈췄다가 안전하게 이어갈 수 있습니다.", icon: "/apps/super-thumbnail/features/feature-08.webp" },
      { title: "원본은 그대로, 썸네일만 새로", body: "새로하기는 선택한 폴더 아래의 .NasFinder-Vault만 확인 후 지우고 다시 만듭니다. 사진과 영상 원본은 삭제하지 않습니다. 보관본을 찾을 때부터 삭제 완료 개수까지 큰 진행 막대로 보여줍니다.", icon: "/apps/super-thumbnail/features/feature-09.webp" },
      { title: "진행 상태를 한눈에", body: "전체 파일 수, 완료 수, 예상 남은 시간, 확인한 원본 용량과 생성된 썸네일 용량을 표시합니다.", icon: "/apps/super-thumbnail/features/feature-10.webp" },
      { title: "Mac에서 직접 처리", body: "파일을 개발자 서버로 보내지 않고 사용자가 선택한 Finder 폴더를 Mac에서 직접 읽고 씁니다.", icon: "/apps/super-thumbnail/features/feature-11.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "여행에서 찍은 사진과 영상이 앨범에만 쌓여 있다면. 한클립은 고르기만 하면 장면 길이와 음악을 맞춰 한 편의 MP4 영화로 완성하고, 골프 스윙의 순간을 알아서 찍는 AiShot까지 담은 iPhone·iPad·Apple Silicon Mac·Android 앱입니다.",
    theme: "coral",
    ...
    features: [
      ...
      { title: "사진부터 Live Photo까지", body: "사진·영상·Live Photo와 Android Motion Photo, 파일과 공유 항목을 가져옵니다.", icon: "/apps/hanclip/features/feature-05.webp" },
      { title: "시사회 후 결정", body: "완성된 영화를 먼저 확인한 뒤 다시 편집하거나 사진 앱·갤러리·파일로 저장합니다.", icon: "/apps/hanclip/features/feature-06.webp" },
      { title: "개봉영화 보관함", body: "새로 완성한 영화는 최대 30편까지 앱 안에 따로 보관합니다. 영화를 길게 눌러 컬렉션에도 바로 추가하고, 개봉영화 원본은 그대로 남길 수 있습니다.", icon: "/apps/hanclip/features/feature-07.webp" },
      { title: "프로젝트 보관", body: "만들던 영화와 컬렉션을 저장해 다음에 이어서 작업할 수 있습니다.", icon: "/apps/hanclip/features/feature-08.webp" },
      { title: "Mac에서도 이어서", body: "Apple Silicon Mac에서 iPad 앱 호환 모드로 실행해 트랙패드와 키보드로 같은 영화 제작 흐름을 사용합니다.", icon: "/apps/hanclip/features/feature-09.webp" },
  ...
  },
  {
    ...
    tagline: "나의 디지털 수도.",
    summary: "내 기억과 정보, 도구가 여기저기 흩어져 있다면, 그것을 한곳에 모아 나를 중심으로 움직이게 하는 개인용 AI. 한양은 그 방향으로 설계하는 프로젝트로, 600년 전 한 나라를 운영하기 위해 세운 계획도시에서 이름을 따왔습니다. 지금은 사진·영상 속 의미 있는 순간을 기기 안에서 이해하는 미디어 지능 코어를 공개하고 있으며, 기억·정리·판단·안전한 실행은 앞으로 하나의 질서로 넓혀 갈 범위입니다.",
    theme: "violet",
    ...
    features: [
      { title: "나를 중심으로 세워진 AI 도시", body: "범용 챗봇 하나를 더 만드는 대신, 한 사람의 기억·정보·도구가 사용자라는 중심을 향해 질서 있게 연결되는 개인 인공지능을 만듭니다.", icon: "/apps/hanai/features/feature-01.webp" },
      { title: "도시처럼 연결되는 개인 AI", body: "대화와 알림이 오가는 길, 지식을 보관하는 공간, 전문 에이전트와 외부 서비스의 관문을 하나의 구조 안에서 연결하는 것이 한양의 방향입니다.", icon: "/apps/hanai/features/feature-02.webp" },
      { title: "한양도성처럼 분명한 경계", body: "개인 데이터와 외부 세계의 경계를 먼저 세웁니다. 원본 영상·사진·프레임·오디오·관절 좌표는 기기 또는 로컬에서만 처리합니다.", icon: "/apps/hanai/features/feature-03.webp" },
      { title: "전통이 아니라 도시 철학", body: "기와·붓글씨 같은 복고 장식을 앞세우지 않습니다. 화면은 현대적이고 직관적으로 유지하고, 한양의 계획도시 개념은 정보 구조와 시스템 설계에 담습니다.", icon: "/apps/hanai/features/feature-04.webp" },
      { title: "현재는 미디어 지능부터", body: "화면 움직임과 자세 흐름, 소리의 특징을 함께 살펴 사진·영상 속 의미 있는 순간을 보수적으로 이해하는 독립 코어를 다듬고 있습니다.", icon: "/apps/hanai/features/feature-05.webp" },
      { title: "비슷한 사진은 줄이고 좋은 장면은 남기기", body: "사진 원본 대신 선명도·크기·거리 같은 익명 수치만 받아 가까운 중복을 묶고, 그중 품질이 좋은 대표 사진을 Swift와 Kotlin에서 같은 기준으로 고릅니다.", icon: "/apps/denimdex/features/photo-compression.webp" },
      { title: "기억에서 안전한 실행까지", body: "다음에는 사용자가 허용한 정보의 기억과 정리, 선택지 비교, 확인을 거친 일상 실행으로 차근차근 범위를 넓혀 갑니다.", icon: "/apps/hanai/features/feature-03.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "머리맡에 세워 두면 낮에는 플립시계와 날씨, 빠방 채널의 작은 영상창을 즐기고, 밤에는 화면을 잠그거나 다른 앱으로 나가도 매이트 모드가 자동으로 이어져 코골이·잠꼬대 같은 수면 소리 후보를 기기 안에만 기록합니다. 아무 소리도 없던 밤과 감지 실패도 분명히 구분해 알려 줍니다.",
    theme: "amber",
    ...
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.5.6 (202609121751) · iOS·iPadOS 17+", availabilityNote: "2.5.6 외부 베타 승인 완료 · 공개 TestFlight 링크에서 참여 가능" },
      {
        name: "macOS",
        status: "공개",
        detail: "2.5.6 · macOS 14+ · Apple 공증 완료",
      ...
      },
      {
        ...
        status: "공개",
        detail: "2.5.6 · Android 8.0+",
        url: releaseDownloadPath("S.tand-Android"),
        downloadLabel: "Android APK 바로 받기",
        availabilityNote: "Android·Google TV용 2.5.6 APK 공개 · 날씨 자동 갱신과 그레이 미니플레이어 · 기존 설정과 기록 유지",
      },
    ],
    features: [
      { title: "빠방의 현재 채널", body: "음악 목록 맨 앞에서 빠방을 선택하면 서버에 준비된 채널이 바로 나타납니다. 왼쪽은 재생·정지, 오른쪽은 다음 곡이며 길게 누르면 빠방 사이트와 같은 순서의 재생목록을 고릅니다.", icon: "/apps/stand/features/feature-07.webp" },
      { title: "덜 겹치는 빠방 재생목록", body: "최근에 들은 영상과 제목으로 확인한 같은 곡을 피하고, 아직 듣지 않은 곡부터 섞습니다. 후보를 모두 들으면 가장 오래전에 들은 곡부터 다시 준비합니다.", icon: "/apps/stand/features/feature-10.webp" },
      { title: "잠깐 다녀와도 같은 위치에서", body: "다른 앱으로 이동하면 영상을 일시정지하고 미니플레이어를 1분 동안 유지합니다. 1분 안에 돌아오면 같은 영상의 같은 위치에서 이어듣기를 요청합니다. Mac·Android 2.5.6 공개, iPhone·iPad 2.5.6 외부 베타 승인 완료.", icon: "/apps/super-thumbnail/features/feature-08.webp" },
      { title: "고정된 미니플레이어", body: "미니플레이어는 설정 버튼과 한 묶음으로 고정되어 재생 중인 곡을 보여 줍니다. 별도 정지·다음·닫기·이동·투명도 버튼 없이 빠방 카드에서 바로 제어합니다.", icon: "/apps/stand/features/feature-06.webp" },
      { title: "켜 둔 동안 새로 받는 날씨", body: "위치 사용을 켜면 앱 화면이 열려 있는 동안 15분마다 날씨를 갱신하고, 약 3km 이상 이동했을 때도 다시 가져옵니다. 통신이 끊기면 기존 날씨를 유지하고 5분 뒤 재시도합니다. 화면을 벗어나거나 위치 사용을 끄면 위치 확인을 멈춥니다.", icon: "/icons/weather-20260918.webp" },
      { title: "미니플레이어도 그레이 테마로", body: "Android에서도 그레이 테마를 고르면 미니플레이어의 영상과 미리보기에 흑백 처리가 적용됩니다. 다른 테마로 바꾸면 원래 색으로 돌아옵니다.", icon: "/apps/stand/features/feature-11.webp" },
      { title: "오브제 모드", body: "플립시계, 날씨와 배터리를 가로·세로 화면에 차분하게 표시합니다.", icon: "/apps/stand/features/feature-01.webp" },
      { title: "매이트와 화들짝", body: "어두운 환경에서 최소 밝기를 유지하고, 매이트 모드 진입 2분 뒤부터 움직임이나 큰소리에 화면과 조명이 반응합니다.", icon: "/apps/stand/features/feature-02.webp" },
      { title: "아이폰 자동 밝기 존중", body: "iPhone·iPad의 시스템 자동 밝기는 그대로 두고 S.tand의 세로 밝기 제스처는 앱 화면의 조명만 조절합니다. 고정 매이트·오브제에서는 선택한 앱 밝기를 유지하고, 자동 모드에서는 실제 시스템 밝기가 바뀔 때 자연스럽게 따라갑니다.", icon: "/apps/stand/features/feature-02.webp" },
      { title: "밤새 이어지는 로컬 수면 기록", body: "화면을 잠그거나 다른 앱으로 나가면 자동으로 매이트 모드가 이어집니다. 코골이·잠꼬대·뒤척임 후보는 기기 안에 기록하며, 아무 소리도 없었던 밤과 감지 실패를 구분해 알려줍니다.", icon: "/apps/stand/features/feature-03.webp" },
      { title: "잠자리별 잠소리 정리", body: "잠자리 패널을 길게 눌러 여러 밤을 고르고 전체 선택·해제할 수 있습니다. 선택한 기록은 한 번에 합치거나 지우며, 패널 안에서는 잠소리 목록을 듣고 필요한 것만 남길 수 있습니다.", icon: "/apps/nasfinder/features/feature-10.webp" },
      { title: "내 화면 만들기", body: "화면을 움직이지 않고 2초 동안 눌렀을 때만 편집을 엽니다. 가로 음량 조절이나 세로 밝기 조절 중에는 편집 모드로 바뀌지 않으며, 밝기·시계 글꼴·배치·테마를 화면 방향에 맞게 꾸밀 수 있습니다.", icon: "/apps/stand/features/feature-11.webp" },
      { title: "보이소", body: "QR로 볼 사람·말할 사람·무전기를 연결하고 Wi‑Fi·Bluetooth·인터넷 경로를 사람별로 한눈에 봅니다. 원음과 녹음은 보내지 않으며, 무전기는 버튼을 눌렀을 때만 연결된 화면을 부릅니다.", icon: "/apps/button/features/feature-10.webp" },
      { title: "두 줄 음악·제어 카드", body: "음악과 잠소리·보이소·설정을 아이콘과 제목, 상태의 두 줄로 또렷하게 보여 줍니다. iPhone·iPad의 음악 카드는 왼쪽 절반으로 재생·일시정지하고 오른쪽 절반으로 다음 라디오나 다음 곡을 고르며, 음악 스트립을 밀면 채널 카드가 움직입니다.", icon: "/apps/stand/features/feature-06.webp" },
      { title: "라디오 프리셋 이동", body: "직접 등록한 HTTP·HTTPS 라디오 채널을 S.tand 파일로 내보내 다른 Apple·Android 기기에서 가져옵니다. Google TV에는 같은 Wi-Fi의 휴대전화로 QR 전송하며 외부 서버를 거치지 않습니다.", icon: "/apps/stand/features/feature-07.webp" },
      { title: "Google TV 리모컨 지원", body: "10-foot 가로 화면에서 D-pad로 음악·설정·테마·밝기·시계 크기를 조작합니다. 버튼을 눌러도 검은 배경이 생기지 않고 포커스 테두리만 또렷하게 보이며, 홈에서 뒤로가기를 누르면 앱이 정상 종료됩니다.", icon: "/apps/stand/features/feature-08.webp" },
      { title: "로고로 최신 버전 확인", body: "홈의 S.tand 로고를 누르면 현재 버전을 바로 확인합니다. iPhone·iPad는 TestFlight, Mac은 Sparkle, Android와 Google TV는 GitHub Releases의 최신 공개판을 확인합니다.", icon: "/apps/ccmb/features/feature-12.webp" },
      { title: "Apple Music 재생 제어", body: "Apple Music과 Classical의 재생 상태를 분리해 유지합니다. 카드 왼쪽 절반은 재생·일시정지를 바꾸고 오른쪽 절반은 다음 곡으로 넘기며, 멈춘 상태에서는 선택한 항목부터 재생합니다.", icon: "/apps/stand/features/feature-10.webp" },
      { title: "자동 매이트 모드", body: "백그라운드 동작은 기본으로 켜져 있습니다. 자동 모드에서 화면을 잠그거나 다른 앱으로 나가면 매이트 모드와 마이크 감지가 먼저 시작되고, 현재 감지 상태를 홈과 기록에서 확인할 수 있습니다.", icon: "/apps/stand/features/feature-02.webp" },
      { title: "재현 가능한 화면 매치업", body: "한국어·서울 시간대·고정 시각 조건에서 iOS와 Android의 공통 화면 상태를 같은 의미 ID로 캡처하고 비교합니다.", icon: "/apps/nasfinder/features/feature-14.webp" },
    ],
    guide: [
      { title: "빠방 듣기", body: "빠방 카드에서 채널을 고르고 재생·정지·다음 곡을 제어합니다. 다른 앱에서는 일시정지하며 1분 안에 돌아오면 이어듣기를 요청합니다. 직접 정지한 영상은 자동으로 재생하지 않습니다. 자동 재생이 막히면 영상의 이어듣기를 눌러 주세요. 운영체제가 플레이어를 종료한 경우에는 새로 재생해야 합니다." },
    ...
    privacy: [
      "빠방 채널 재생 시 ppabang.net과 YouTube에 연결합니다. 영상과 재생 요청은 해당 서비스에서 처리하며, 음악 재생에는 인터넷 연결이 필요합니다.",
      "빠방은 반복 방지를 위해 최근 영상 식별자·재생 시각·곡 구분값을 앱의 웹 저장공간에 보관합니다. 새 목록 요청 시 제외할 식별자·곡 구분값을 서버에 보내며 서버에는 이 목록을 저장하지 않습니다. 일반 웹 브라우저와 앱의 기록은 자동 공유되지 않습니다.",
  ...
  },
  {
    ...
    tagline: "AI 한도, 한눈에.",
    summary: "한창 작업하다가 Claude 한도에 걸려 멈춰 본 적 있나요? CCMB는 Mac이 읽은 Codex·Claude·Gemini 사용량을 메뉴 막대에 숫자로 띄우고, 남은 한도·초기화 시각·크레딧·최근 소비 흐름을 iPhone·iPad에서도 이어 봅니다. 동기화에는 iCloud 개인 영역이나 사용자가 고른 클라우드 파일만 씁니다.",
    theme: "blue",
    ...
    features: [
      ...
      { title: "낭비를 줄이는 스마트 갱신", body: "사용량 변화에 맞춰 갱신 간격을 조절하고, Claude 세션이나 주간 잔량이 소진되면 초기화 시각까지 의미 없는 요청을 멈춥니다.", icon: "/apps/ccmb/features/feature-10.webp" },
      { title: "Gemini 온라인 사용량", body: "CCMB 안에서 Gemini 사용량 페이지를 한 번 연결하면 온라인 세션·주간 잔량과 초기화 시각을 안전하게 다시 읽습니다. CLI 세션을 아직 쓰지 않았다면 초기화 시각 대신 사용 시작 후 5시간이라고 안내합니다.", icon: "/apps/ccmb/features/feature-11.webp" },
      { title: "같은 모양의 두 패널", body: "메뉴 막대에서 여는 패널과 항상 보기 패널에 같은 정보·간격·하단 설정을 제공합니다.", icon: "/apps/ccmb/features/feature-04.webp" },
      { title: "배경 불투명도", body: "두 패널의 전체 배경 불투명도를 95%~100% 범위에서 수치를 보며 조절합니다.", icon: "/apps/ccmb/features/feature-05.webp" },
      { title: "정렬된 계정·갱신 정보", body: "세 서비스의 요금제·계정 정보·상대 갱신 시각을 같은 기준선에서 비교합니다.", icon: "/apps/ccmb/features/feature-09.webp" },
      { title: "간결해진 하단 조작", body: "업데이트 확인과 현재 버전을 합치고 투명도, 재시작과 종료 조작을 같은 3열 그리드 안에 정돈했습니다.", icon: "/apps/ccmb/features/feature-07.webp" },
      { title: "로컬 공유", body: "최신성 근거가 포함된 로컬 JSON을 다른 앱과 Codex 대화에서 안전하게 읽습니다.", icon: "/apps/nasfinder/features/feature-10.webp" },
      { title: "더 안정적인 Codex 사용량", body: "Codex CLI가 이미 로그인한 세션을 이용해 주간 한도, 초기화 쿠폰과 크레딧을 직접 읽어 표시합니다. 종료된 Spark는 현재 사용량에서 제외하며 과거 기록은 보존합니다.", icon: "/apps/ccmb/features/feature-06.webp" },
      { title: "한 줄로 온전히 보이는 갱신 기록", body: "중복 서비스 이름과 말줄임표 없이 현재 서비스별 갱신당 사용량을 한 줄로 표시하고, 막대 위 시각은 초 없는 24시간제로 보여 줍니다.", icon: "/apps/starmanager/features/feature-07.webp" },
      { title: "사라지지 않는 연결 복구", body: "응답 지연과 Mac의 잠자기·깨우기 뒤에도 앱을 종료하지 않고 데이터 연결만 안전하게 다시 시작합니다.", icon: "/apps/ccmb/features/feature-10.webp" },
      { title: "CCMB 전용 Claude 연결", body: "CCMB 안의 브라우저에서 Claude 계정을 한 번 연결합니다. Claude Code의 키체인 인증 정보를 읽지 않아 다른 앱의 승인 창이 반복되지 않습니다.", icon: "/apps/aibi/features/feature-01.webp" },
      { title: "항상 자동인 서명 업데이트", body: "Sparkle과 GitHub Releases를 통해 새 버전을 자동으로 확인하고 내려받습니다. 수동 업데이트 확인도 남겨 두되 별도의 자동 다운로드 선택은 필요 없습니다.", icon: "/apps/ccmb/features/feature-12.webp" },
      { title: "로그인 시 시작", body: "선택하면 Mac 로그인과 함께 조용히 실행됩니다.", icon: "/apps/ccmb/features/feature-13.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "빌드 몇 번 돌렸을 뿐인데 디스크가 차고 Mac이 느려졌다면. BTN은 AI·개발 작업 뒤 남은 시뮬레이터와 빌드 산출물, 놀고 있는 개발 프로세스를 찾아 위험도와 이유를 설명하고, 안전한 파일은 자동으로, 나머지는 직접 고른 항목만 다시 확인한 뒤 정리하는 macOS 메뉴 막대 앱입니다.",
    theme: "blue",
    ...
    features: [
      { title: "메모리 압박 해결 동선", body: "메모리 압박 경고에서 실행 중인 시뮬레이터를 기기 데이터를 유지한 채 종료하거나 활동 모니터로 일반 앱을 바로 확인합니다.", icon: "/apps/btn/features/feature-01.webp" },
      { title: "DerivedData 한 번에 비우기", body: "필요할 때 버튼 한 번으로 Xcode DerivedData 안의 빌드 산출물을 모두 휴지통으로 옮기고, 다음 빌드에서 깨끗하게 다시 생성합니다.", icon: "/apps/btn/features/feature-02.webp" },
      { title: "안전한 파일 자동 정리", body: "저위험이며 휴지통에서 복원 가능한 오래된 DerivedData와 XCTest 데이터만 자동으로 정리합니다.", icon: "/apps/btn/features/feature-05.webp" },
      { title: "시뮬레이터 잔여물 진단", body: "사용할 수 없어진 시뮬레이터와 명시적으로 확인된 XCTest 복제 기기를 찾아 디스크 사용량과 함께 보여줍니다.", icon: "/apps/btn/features/feature-04.webp" },
      { title: "시뮬레이터 데이터 초기화", body: "종료된 정상 시뮬레이터 데이터가 512 MiB 이상이면 기기는 남기고 앱·콘텐츠 데이터만 초기화할 수 있습니다.", icon: "/apps/btn/features/feature-05.webp" },
      { title: "DerivedData 안전 정리", body: "실행 중인 Xcode 빌드·테스트가 없을 때만 오래된 개별 DerivedData 폴더를 후보로 제안합니다.", icon: "/apps/btn/features/feature-02.webp" },
      { title: "유휴 프로세스 메모리 회수", body: "엄격한 유휴 조건을 충족한 Gradle·Kotlin 데몬, 테스트 러너와 브라우저 자동화만 종료 후보로 제안하며 로컬 개발 서버는 관찰만 합니다.", icon: "/apps/btn/features/feature-07.webp" },
      { title: "기본은 선택 안 함", body: "발견한 항목을 자동 선택하거나 즉시 지우지 않습니다. 사용자가 이유와 경로를 보고 직접 고릅니다.", icon: "/apps/btn/features/feature-08.webp" },
      { title: "실행 직전 다시 확인", body: "파일 식별 정보와 시뮬레이터 상태, 프로세스의 소유자·PID·명령·시작 시각을 조치 직전에 다시 검증해 바뀐 대상은 건너뜁니다.", icon: "/apps/btn/features/feature-08.webp" },
      { title: "파일은 우선 휴지통으로", body: "DerivedData와 XCTest 산출물은 복구할 수 있도록 휴지통으로 이동합니다. 시뮬레이터 삭제는 되돌릴 수 없음을 별도로 경고합니다.", icon: "/apps/btn/features/feature-09.webp" },
      { title: "로컬에서만 작동", body: "진단과 정리 판단은 Mac 안에서 규칙으로 수행하며 원격 분석이나 사용자 파일 업로드를 하지 않습니다.", icon: "/apps/super-thumbnail/features/feature-11.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "글을 쓰다 손바닥이 트랙패드에 닿아 커서가 엉뚱한 곳으로 튀어 본 적 있나요? 트랙패드가드는 키를 누르는 동안 트랙패드의 이동·클릭·스크롤을 막고, 마지막 입력 1초 뒤나 정해 둔 영역을 터치하면 바로 풀어 주는 macOS 메뉴 막대 앱입니다. 영타로 친 한글 오타를 바로잡는 변환도 함께 담았습니다.",
    theme: "blue",
    ...
    features: [
      { title: "키 입력과 동시에 잠금", body: "문자를 입력하기 시작하면 트랙패드의 커서 이동, 클릭과 스크롤을 바로 차단합니다.", icon: "/apps/trackpadguard/features/feature-01.webp" },
      { title: "1초 후 자동 해제", body: "마지막 키 입력 뒤 1초 동안 추가 입력이 없으면 트랙패드 잠금을 자동으로 해제합니다.", icon: "/apps/trackpadguard/features/feature-02.webp" },
      { title: "터치로 자연스럽게 해제", body: "기본 사다리꼴 또는 사용자가 정한 영역을 새로 터치하면 트랙패드가 즉시 다시 작동합니다.", icon: "/apps/trackpadguard/features/feature-03.webp" },
      { title: "눈으로 편집하는 영역", body: "설정 화면에서 네 꼭짓점을 직접 드래그해 손과 사용 습관에 맞는 해제 영역을 만듭니다.", icon: "/apps/trackpadguard/features/feature-04.webp" },
      { title: "실패 안전 설계", body: "멀티터치 좌표를 읽지 못하면 잠금을 시작하지 않으며, 긴급 단축키로 언제든 즉시 해제할 수 있습니다.", icon: "/apps/trackpadguard/features/feature-05.webp" },
      { title: "서명된 자동 업데이트", body: "Sparkle과 GitHub Releases를 통해 서명된 새 버전을 확인하고 설치합니다.", icon: "/apps/ccmb/features/feature-12.webp" },
      { title: "눈에 보이는 잠금 상태", body: "가드가 적용되면 메뉴 막대 아이콘이 빨간색으로 바뀌고 해제되면 원래 색으로 돌아옵니다.", icon: "/apps/trackpadguard/features/feature-07.webp" },
      { title: "영타로 친 한글 자동·강제 변환", body: "두 단어 이상의 영문 자판 한글 오타는 공백·문장부호·엔터에서 자동으로 바꿉니다. 영어를 거의 쓰지 않는 사용자는 한글 우선 변환을 켜 조합 가능한 문장을 더 적극적으로 바꿀 수 있습니다. 한 단어는 끝에 ''를 입력해 강제로 변환하며, 비밀번호 창에서는 작동하지 않습니다.", icon: "/icons/keyboard-language-20260918.webp" },
      { title: "높은 부하 자동 복구와 안정성", body: "CPU·메모리 부하 시 보호 기능을 먼저 다시 시작하고, 장시간 사용 중 드문 키 입력 유실을 줄이기 위해 30분 주기 재시작 설계를 적용했습니다. 설정에서 자동 복구를 끌 수도 있습니다.", icon: "/apps/btn/features/feature-01.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "출근길에 오늘 매출과 서버 상태만 빠르게 확인하고 싶을 때. HtOMS 브리프는 HtOMS의 실제 OMS 데이터를 읽어 오늘·이번 달 매출, 시간대·월간 추이, 출고 현황과 외부 서버 상태를 한 화면에 보여주는 iPhone·iPad·Android용 읽기 전용 앱입니다. 회사 내부용 도구로 OMS 계정 로그인이 필요합니다.",
    theme: "blue",
    ...
    features: [
      ...
      { title: "화면 안전 영역", body: "상태 표시줄과 내비게이션 영역을 피해 콘텐츠를 배치해 최신 Android의 edge-to-edge 화면에서도 숫자와 버튼이 가려지지 않습니다.", icon: "/apps/stand/features/feature-04.webp" },
      ...
      { title: "안전한 로그인", body: "로그인 세션은 Apple Keychain 또는 Android Keystore로 보호하며 앱 화면과 일반 저장 데이터에 원문을 노출하지 않습니다.", icon: "/apps/htoms-brief/features/feature-05.webp" },
      { title: "홈 화면 위젯", body: "앱에서 갱신한 핵심 브리프를 iPhone·iPad와 Android 홈 화면에서도 빠르게 확인합니다.", icon: "/apps/htoms-brief/features/feature-06.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "자주 가는 사이트인데 주소는 늘 기억이 안 난다면. 인투샾은 검색과 즐겨 찾는 사이트를 한 화면에 모아, 사이트 이름이나 검색어 한 줄로 바로 이동하는 개인화 웹 시작 페이지입니다.",
    theme: "blue",
  ...
  },
  {
    ...
    summary: "검증된 교회의 설교와 찬양을 큰 글씨와 넓은 버튼으로 편하게 찾고 싶다면. 에어처치는 확인을 거친 교회의 말씀과 찬양을 발견하고, 우리 교회를 응원하며, 가진 달란트로 이웃의 필요를 잇는 크리스천 웹 포털입니다.",
    theme: "coral",
    ...
    features: [
      { title: "누구나 편한 첫 화면", body: "말씀 보기·찬양 듣기·교회 찾기를 큰 바로가기와 넓은 버튼으로 쉽게 시작합니다.", icon: "/apps/intosharp/features/feature-04.webp" },
      { title: "오늘의 말씀과 찬양", body: "많이 찾는 교회와 목사의 공식 채널을 먼저 확인하면서, 지역 교회의 최신 설교와 찬양도 함께 발견합니다.", icon: "/apps/airchurch/features/feature-01.webp" },
      { title: "목사님 발견 이어가기", body: "목사님 페이지 하단에서 다른 목회자 8명을 새롭게 추천받고, 한 사람의 사역 기록을 계속 둘러봅니다.", icon: "/apps/airchurch/features/feature-02.webp" },
      { title: "경쟁보다 발견", body: "목회자의 서열을 만들기보다 작은 교회와 지역의 꾸준한 사역이 발견되도록 보여줍니다.", icon: "/apps/intosharp/features/feature-02.webp" },
      { title: "착한나눔", body: "시간, 경험, 공간, 기술과 기도를 필요한 교회와 이웃에게 연결합니다.", icon: "/apps/airchurch/features/feature-03.webp" },
      { title: "서로를 지키는 광장", body: "개인정보를 최소화한 별칭으로 이야기를 나누고 운영 원칙에 따라 첫 글을 검토합니다.", icon: "/apps/airchurch/features/feature-04.webp" },
      { title: "분명한 검증 기준", body: "교단·노회·공식 홈페이지와 영상 채널을 교차 확인하고 신고·재검토·이의제기 절차를 둡니다.", icon: "/apps/airchurch/features/feature-05.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "방에 있는 아이를 부르러 계단을 오르내리거나 전화를 걸 필요 없이, 버튼 하나로. 아워버튼은 가족 기기를 QR로 묶고 톡톡·띵동·음성 메시지와 긴급 사이렌을 보내는 iPhone·Android 가족 호출 앱입니다. 아이도 한눈에 구분하는 밝고 따뜻한 화면이며, 멀리 있는 가족에게는 개인 NAS가 호출을 중계합니다.",
    theme: "coral",
    ...
    features: [
      { title: "톡톡에서 사이렌까지", body: "톡톡은 탭하면 소리 없이 전해지고, 5초간 누르면 보낸 기기는 조용한 채 상대 기기에 강력한 사이렌을 보냅니다.", icon: "/apps/button/features/feature-01.webp" },
      { title: "녹음하고 확인해서 보내기", body: "음성을 녹음한 뒤 보내기 또는 취소를 한 번 더 고릅니다. 받는 사람은 앱에서 바로 듣고 최근 기록에서 다시 들을 수 있습니다.", icon: "/apps/button/features/feature-02.webp" },
      { title: "한 명·여러 명 또는 모두에게", body: "원거리에 있는 가족까지 받을 사람 목록에 표시합니다. 한 명 이상을 골라 보내거나 선택 없이 모두에게 보냅니다.", icon: "/apps/button/features/feature-03.webp" },
      { title: "앱을 보는 동안 화면 유지", body: "OurButton 앱이 앞에 열려 있는 동안에는 화면이 꺼지지 않아 가족 호출 버튼을 바로 누를 수 있습니다.", icon: "/apps/button/features/feature-04.webp" },
      { title: "여러 가족 공간", body: "가족별로 별도 공간을 만들고 참여한 공간 사이를 전환할 수 있어 다른 가족에게도 같은 앱을 소개해 사용할 수 있습니다.", icon: "/apps/button/features/feature-05.webp" },
      { title: "잠금화면 원격 수신", body: "iPhone은 APNs, Android는 FCM을 사용해 앱이 화면에 없거나 잠겨 있을 때도 대상 호출을 안전하게 전달합니다.", icon: "/apps/button/features/feature-06.webp" },
      { title: "근거리 연결과 원거리 중계", body: "가까운 기기는 직접 연결하고, 개인 Synology NAS 중계 서버가 iPhone과 Android의 원거리 호출을 함께 이어줍니다.", icon: "/apps/button/features/feature-07.webp" },
      { title: "20개 기록과 확인 인원", body: "최근 기록은 20개만 남기고 오래된 항목부터 정리합니다. 보낸 기록 오른쪽에는 아직 확인하지 않은 사람 수가 표시되고 모두 확인하면 사라집니다.", icon: "/apps/button/features/feature-08.webp" },
      { title: "자녀의 연속 호출 방지", body: "자녀가 호출한 뒤에는 10초 동안 남은 시간을 표시해 실수로 연속 전송하는 일을 막고, 부모는 제한 없이 바로 다시 보낼 수 있습니다.", icon: "/apps/button/features/feature-09.webp" },
      { title: "부모와 자녀 모두 음성 전송", body: "부모와 자녀 모두 톡톡·띵동·음성을 보낼 수 있고, 자녀의 연속 호출만 10초 동안 제한합니다.", icon: "/apps/button/features/feature-10.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "사진은 골랐는데 게시물 문구가 떠오르지 않을 때. 스타그램은 사진만, 사진과 글, 글만으로 시작해도 Gemini·ChatGPT·Claude 또는 기기 AI가 내 말투에 맞는 초안을 완성해 주고, 미디어를 보며 한 화면에서 다듬어 Instagram 등 원하는 앱으로 바로 이어가는 iPhone·iPad·Android 앱입니다.",
    theme: "violet",
    ...
    features: [
      { title: "고른 사진을 모두 AI에", body: "사진 1~8장을 고른 순서대로 Gemini·ChatGPT·Claude에 전달합니다. 사진만 맡기거나 사진과 글을 함께 보내도 되고, 영상은 AI 첨부에서 제외됩니다.", icon: "/apps/starmanager/features/feature-01.webp" },
      { title: "화면을 가리지 않는 외부 AI", body: "ChatGPT·Gemini·Claude에 요청을 보낸 뒤에도 스튜디오 화면을 그대로 보며 전송 완료·대기 시간·오류 상태를 확인할 수 있습니다.", icon: "/apps/starmanager/features/feature-02.webp" },
      { title: "필요할 때만 브라우저 보기", body: "브라우저 보기는 기본적으로 꺼져 있습니다. 설정에서 켜면 생성 시작부터 공식 웹 화면을 볼 수 있고, 꺼져 있어도 로그인·보안 확인이 필요할 때는 자동으로 화면을 엽니다.", icon: "/apps/starmanager/features/feature-03.webp" },
      { title: "로그인 상태를 직접 관리", body: "설정에서 Gemini·ChatGPT·Claude의 로그인 상태를 다시 확인하고, 모두 로그아웃한 뒤 필요한 서비스에 다시 로그인할 수 있습니다.", icon: "/apps/starmanager/features/feature-04.webp" },
      { title: "결과를 안정적으로 가져오기", body: "외부 AI의 완성된 답변을 감지해 Stargram 초안으로 바로 가져옵니다. 결과를 받거나 화면을 스크롤하면 입력 키보드는 다시 입력창을 누를 때까지 숨깁니다.", icon: "/apps/starmanager/features/feature-05.webp" },
      { title: "한 번 보내고, 진행은 분명하게", body: "Gemini·Claude의 사진과 요청 본문 전달을 보강하고, 취소된 첨부파일을 정리한 뒤 입력창 준비 상태를 확인해 안정적으로 전송합니다. 이미 보낸 요청의 반복 전송도 방지합니다.", icon: "/apps/starmanager/features/feature-06.webp" },
      { title: "문제가 생기면 진단 로그 공유", body: "2.6.4 설정에서 AI 작업 단계와 소요 시간을 담은 진단 로그를 공유할 수 있습니다. 사진·글·답변·로그인 정보는 기록하지 않습니다.", icon: "/apps/starmanager/features/feature-07.webp" },
      { title: "원하는 AI를 바로 선택", body: "Gemini·ChatGPT·Claude·기기 AI를 한 줄에서 고르고 각 AI의 만들기 버튼으로 곧바로 실행합니다.", icon: "/apps/ccmb/features/feature-01.webp" },
      { title: "접어 두는 글 스타일", body: "글자 수·이모지·분위기·스타일·말투·나잇대·줄넘김·내 글 반영은 필요할 때만 펼칩니다. 추가 요청은 같은 패널에서 직접 적습니다.", icon: "/apps/hanclip/features/feature-04.webp" },
      { title: "새 캔버스로 다시 시작", body: "하단의 새 캔버스로 현재 이야기와 결과, 미디어만 비우고 나의 취향과 프로필은 그대로 유지합니다.", icon: "/apps/btn/features/feature-04.webp" },
      { title: "미디어와 Instagram 공유", body: "사진·영상을 최대 8개까지 담고 순서를 정한 뒤, 문구 자동 복사와 공유 화면으로 Instagram 새 게시물 등 원하는 앱에 연결합니다. 카메라 사진은 사진 앱·갤러리에도 보관합니다.", icon: "/apps/starmanager/features/feature-09.webp" },
      { title: "사진 앱에서 바로 시작", body: "사진 앱의 공유 메뉴에서 사진을 최대 8장까지 Stargram으로 보내면 공동 보관함을 거쳐 새 자동화 캔버스에 바로 채웁니다.", icon: "/apps/aibi/features/feature-04.webp" },
      { title: "내가 켤 때만 자동화", body: "자동화는 처음에는 꺼져 있습니다. 설정에서 직접 켜면 앱을 열거나 15초 이상 쉬었다 돌아올 때 사진 선택부터 Gemini·ChatGPT·Claude 전달까지 이어집니다.", icon: "/apps/starmanager/features/feature-06.webp" },
      { title: "공유와 카메라는 언제나", body: "자동화를 꺼 둬도 사진 앱에서 바로 공유할 수 있고, 홈 화면의 Stargram 아이콘을 길게 눌러 카메라를 곧바로 열 수 있습니다.", icon: "/apps/hanai/features/feature-05.webp" },
      { title: "인터스텔라 테마", body: "BK·클래식과 함께 은빛과 금빛이 도는 어두운 인터스텔라 화면과 전용 앱 아이콘을 선택할 수 있습니다.", icon: "/apps/starmanager/features/feature-08.webp" },
      { title: "취소와 붙여넣기 안내", body: "게시물 만들기에서 취소를 누르면 작성 중인 내용을 버릴지 확인할 수 있습니다. iPhone·iPad에서 붙여넣기가 막히면 설정 → 앱 → Stargram → 다른 앱에서 붙여넣기를 허용으로 바꾸고, Android는 앱별 붙여넣기 권한을 따로 설정하지 않습니다.", icon: "/apps/starmanager/features/feature-10.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "월드는 NAS에 안전하게", body: "월드와 설정을 컨테이너 밖의 전용 데이터 폴더에 보관해 컨테이너를 업데이트해도 플레이 기록을 이어갑니다.", icon: "/apps/minecraft-server/features/feature-02.webp" },
      { title: "집 안에서 먼저 시작", body: "처음에는 같은 Wi-Fi 안에서만 접속해 정상 동작을 확인하고, 자녀 기기에는 NAS 내부 주소와 Bedrock 포트만 등록합니다.", icon: "/apps/minecraft-server/features/feature-03.webp" },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "영업 중인지 바로 전화하기", body: "전화번호가 있는 추천 식당은 원형 전화 버튼으로 바로 연결하고, 오늘의 결정에서는 번호도 함께 확인합니다.", icon: "/apps/whattoeat/features/feature-05.webp" },
      { title: "가죽판에서 이어지는 선택", body: "첫 화면의 가죽 추천판을 제목 바로 아래에 두고 위치 선택 패널은 스티치 안쪽 폭에 맞췄습니다. 하단 메뉴는 같은 가죽 질감과 눌린 바늘 홈을 쓰고 추천 버튼 돌출부까지 스티치를 이었습니다.", icon: "/apps/whattoeat/features/feature-06.webp" },
      { title: "점심 가방으로 바로 추천", body: "홈과 하단의 추천 버튼을 누르면 전체 분류로 새 추천을 시작합니다. 선택 중에도 원과 글자는 차분한 흰색을 유지하고 아래 빨간 막대만 보여 줍니다.", icon: "/apps/whattoeat/features/feature-07.webp" },
      { title: "실내에서도 멈추지 않는 위치 찾기", body: "GPS가 느린 실내에서는 운영체제가 Wi-Fi와 셀룰러를 함께 활용해 위치를 찾습니다. 12초 안에 새 위치가 없으면 5분 이내의 최근 위치를 사용하고, 그것도 없으면 지역 직접 선택과 다시 시도로 바로 이어갑니다.", icon: "/apps/whattoeat/features/feature-08.webp" },
    ...
    privacy: [
      "공공기관 식사 이용 명단은 앱에 포함되며, 기록 상세에서 공식 원문을 열면 해당 기관의 웹사이트로 이동합니다.",
  ...
  },
  {
    ...
    summary: "옷장 속 빈티지 데님이 어느 시대, 어느 공장 것인지 궁금하다면. 데님덱스는 여러 각도로 찍은 사진을 한양과 아이비가 살펴 제품 정보와 추정 생산연도·제조공장, 희귀도를 분석하고, 한국·일본의 보수적인 적정 매입가를 근거와 함께 보여 줍니다. 결과는 나만의 아카이브에 남겨 둘 수 있습니다.",
    theme: "blue",
    ...
    features: [
      { title: "팬츠와 재킷, 아홉 장이면 순서대로", body: "전체 앞면부터 패치, 레드탭, 버튼 각인, 케어라벨, 리벳과 봉제까지 제품마다 정해진 아홉 단계로 촬영합니다. 각 줄의 실제 참고 이미지를 누르면 더 크게 보며 같은 구도를 맞출 수 있습니다.", icon: "/apps/denimdex/features/photo-details.webp" },
      { title: "자유 촬영은 최대 30장 그대로", body: "정해진 순서보다 직접 고르고 싶다면 자유 촬영에서 전체 실루엣과 원하는 디테일을 최대 30장까지 담고 중요한 순서로 정리할 수 있습니다.", icon: "/apps/aibi/features/feature-04.webp" },
      ...
      { title: "제품 정보와 생산 단서를 먼저", body: "사진에서 확인한 브랜드·모델과 함께 추정 생산연도, 추정 제조공장, 그 판단에 사용한 라벨·버튼·리벳·봉제 단서를 구분해 보여줍니다.", icon: "/apps/denimdex/features/manufacturing-clues.webp" },
      { title: "근거에 맞춘 보수적 희귀도", body: "단종 여부와 생산 시기, 세부 사양처럼 사진으로 뒷받침되는 요소를 중심으로 희귀도를 평가합니다. 근거가 부족하면 과감히 판단을 보류합니다.", icon: "/apps/denimdex/features/rarity-evidence.webp" },
      { title: "한국과 일본의 적정 매입가를 나란히", body: "제품 정보와 상태, 희귀도를 바탕으로 과도한 기대가를 피한 적정 매입 범위를 한국 원화와 일본 엔화로 함께 보여줍니다.", icon: "/apps/denimdex/features/market-prices.webp" },
      { title: "팔았을 때 남는 금액까지", body: "예상 판매가에서 시장별 수수료와 배송비를 반영한 순수익을 계산하고, 일본에서 사서 한국에 팔거나 반대로 거래할 때의 예상 차익도 손해 구간까지 숨김없이 표시합니다.", icon: "/apps/denimdex/features/net-profit.webp" },
      { title: "판단 근거와 확실성을 함께", body: "제품명만 단정하지 않고 사진에서 직접 확인한 특징, 추정한 내용과 신뢰 수준을 구분해 보여줍니다. 실시간 거래 시세가 아닌 AI 기반 참고 범위라는 한계도 함께 안내합니다.", icon: "/apps/denimdex/features/evidence-confidence.webp" },
      { title: "나만의 데님 아카이브", body: "감정 결과와 고른 사진을 기기 안 개인 아카이브에 저장해 다시 확인하고, 필요 없는 기록은 직접 삭제할 수 있습니다.", icon: "/apps/denimdex/features/denim-archive.webp" },
      { title: "사진은 가볍게, 단서는 선명하게", body: "선택 장수가 많아질수록 전송용 사본의 크기와 품질을 단계적으로 조절해 전체 용량을 약 16MB 안으로 맞춥니다. 원본 사진은 변경하지 않습니다.", icon: "/apps/denimdex/features/photo-compression.webp" },
      { title: "작성 중인 글은 그대로 보호", body: "ChatGPT 입력창에 다른 글이 있으면 덮어쓰지 않고 멈춥니다. 빈 입력창에서도 실제로 요청이 들어갔는지 확인한 뒤 다음 단계로 넘어가며, 사진을 읽지 못해도 앱을 닫지 않고 다시 고를 수 있습니다.", icon: "/apps/trackpadguard/features/feature-05.webp" },
      { title: "전송은 한 번, 문제 확인은 간단하게", body: "0.3.2는 사진 첨부와 생성 시작을 확인하고 중복 전송·취소 후 전송을 방지합니다. 문제가 생기면 설정에서 사진과 글이 포함되지 않은 진단 로그를 공유할 수 있습니다.", icon: "/apps/starmanager/features/feature-07.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "출발지와 도착지를 지도에 하나씩 찍는 일이 번거로웠다면. Alfred에서 ‘길찾기 출발지, 도착지’ 한 줄만 입력하면 네이버 지도 자동차 경로가 바로 열립니다.",
    theme: "blue",
    icon: "/apps/alfred-navermap/icon.svg",
    heroImage: "/apps/alfred-navermap/hero-20260918.webp",
    ...
    features: [
      { title: "쉼표 하나로 두 장소를", body: "‘길찾기 고양시 덕양구, 부안여고’처럼 출발지와 도착지를 한 줄에 입력합니다.", icon: "/apps/whattoeat/features/feature-01.webp" },
      { title: "자동차 경로로 바로", body: "네이버 지도가 자동차 탭으로 열립니다. 대중교통·도보·자전거는 지도에서 필요할 때 바꿀 수 있습니다.", icon: "/apps/whattoeat/features/feature-04.webp" },
      { title: "학교 약칭도 알아서", body: "여고·남고·여중은 전체 학교명으로 풀어 검색합니다. 같은 이름의 장소가 있다면 지역명을 함께 적어 주세요.", icon: "/apps/intosharp/features/feature-02.webp" },
      { title: "별도 API 키 없이", body: "Mac의 기본 장소 검색 기능을 사용합니다. API 키나 브라우저 자동화 권한을 설정할 필요가 없습니다.", icon: "/apps/aibi/features/feature-01.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "브라우저를 열고 탭을 찾는 대신, 떠오른 질문을 그 자리에서. Alfred에 지·클·제 한 글자와 질문을 적으면 ChatGPT·Claude·Gemini가 답하는 macOS 워크플로우입니다. 가벼운 질문은 Alfred 안에서 확인하고 깊은 대화는 각 AI 앱으로 이어가며, 별도 API 키 대신 사용자가 로그인한 공식 CLI를 씁니다.",
    theme: "blue",
    ...
    features: [
      { title: "지·클·제 세 글자로 바로 질문", body: "Alfred를 열고 지는 ChatGPT, 클은 Claude, 제는 Gemini를 뜻하는 한 글자 키워드 뒤에 질문을 입력하고 Return을 누르면 빠른 답변을 받습니다.", icon: "/apps/ccmb/features/feature-03.webp" },
      { title: "가볍게는 Alfred 안에서", body: "Return 한 번으로 낮은 추론 강도의 빠른 모델을 실행합니다. 기다리는 동안 진행 상태를 보여주고, 생성이 끝나면 Alfred의 텍스트 화면에서 질문과 답을 바로 확인합니다.", icon: "/apps/aibi/features/feature-02.webp" },
      { title: "⌘Return으로 AI 앱에서 깊게", body: "더 깊게 이어갈 때는 질문을 입력한 채 ⌘Return을 누릅니다. 앱마다 다른 실행 시간을 기다리고 활성 입력창이 준비된 순간 질문을 붙여 넣지만 자동으로 전송하지는 않습니다.", icon: "/apps/starmanager/features/feature-02.webp" },
      { title: "대화 기록은 AI별로 분리", body: "ChatGPT·Claude·Gemini의 질문과 답을 각각 보관하고, 링크를 열었다 돌아와도 마지막 결과와 이전 기록을 다시 볼 수 있습니다.", icon: "/apps/nasfinder/features/feature-10.webp" },
      { title: "API 키를 따로 보관하지 않음", body: "워크플로우에 API 키를 입력하거나 저장하지 않습니다. 각 제공자의 공식 CLI에 사용자가 직접 로그인한 계정 세션으로 답을 생성합니다.", icon: "/apps/aibi/features/feature-01.webp" },
      { title: "다른 Mac에서도 CLI 자동 탐색", body: "사용자 이름이 들어간 고정 경로 대신 PATH와 일반적인 설치 위치를 확인해 Codex·Claude·Gemini 실행 파일을 찾습니다.", icon: "/apps/super-thumbnail/features/feature-07.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "앱 안에서 ChatGPT·Gemini·Claude를 쓰고 싶지만 API 키를 넣거나 계정을 맡기고 싶지는 않다면. 아이비는 사용자가 직접 로그인한 공식 웹 세션을 앱 안에서 안전하게 이어 쓰는 공통 엔진으로, 스타그램과 데님덱스 안에서 작동합니다. 제공자 화면이 바뀌어도 앱 고유 화면과 결과 흐름은 지키며 업데이트합니다.",
    theme: "blue",
    ...
    features: [
      { title: "내 계정은 공식 페이지에 그대로", body: "비밀번호·쿠키·토큰을 복사하거나 저장하지 않고 사용자가 각 AI 공식 웹사이트에서 직접 만든 로그인 세션만 브라우저 표준 저장소로 재사용합니다.", icon: "/apps/aibi/features/feature-01.webp" },
      { title: "필요할 때만 나타나는 AI 브라우저", body: "평소에는 작성 화면을 유지하며 진행 상태를 보여주고, 로그인·보안 확인처럼 사용자가 직접 해야 하는 순간에만 같은 작업을 보이는 브라우저로 안전하게 넘깁니다.", icon: "/apps/aibi/features/feature-02.webp" },
      { title: "완성된 답만 정확히 한 번", body: "사진 첨부와 실제 생성 시작을 확인합니다. 취소된 첨부 정리와 입력창 준비 감지를 거쳐 전송하며, 안정된 최종 결과만 앱에 한 번 반영합니다.", icon: "/apps/aibi/features/feature-03.webp" },
      { title: "로그 하나로 원인 확인", body: "사진·글·답변·계정 정보 없이 작업 단계·소요 시간·개수를 기록합니다. 최근 10개 작업, 작업당 최대 400개 기록을 기기에 보관하고 사용자가 직접 공유할 수 있습니다.", icon: "/apps/starmanager/features/feature-07.webp" },
      { title: "사진을 순서대로, 빠짐없이", body: "기본 8장, 앱이 명시적으로 허용하면 최대 20장까지 순서를 유지해 전달합니다. 원본은 바꾸지 않고 긴 변 2,048px·장당 2MB 안의 전송용 사본만 차례대로 만듭니다.", icon: "/apps/aibi/features/feature-04.webp" },
      { title: "로그아웃과 재로그인까지", body: "각 서비스의 로그인 상태를 다시 확인하고, 앱 전용 웹 세션을 모두 로그아웃한 뒤 필요한 계정으로 다시 로그인할 수 있습니다.", icon: "/apps/aibi/features/feature-05.webp" },
      { title: "기다림과 취소가 분명하게", body: "생성 뒤 1분 59초의 남은 시간과 감소하는 진행 막대를 보여주며, 숨김·보이기 화면 어디서든 취소하면 작업과 브라우저를 즉시 정리합니다.", icon: "/apps/aibi/features/feature-06.webp" },
      { title: "제공자 변화는 어댑터에서만", body: "Gemini·ChatGPT·Claude의 화면 구조 변화는 제공자별 선택자와 회귀 자료에 격리해 공통 상태 기계와 앱 결과 흐름을 흔들지 않습니다.", icon: "/apps/aibi/features/feature-07.webp" },
      { title: "앱별 수정은 덮어쓰지 않는 업데이트", body: "버전과 무결성 잠금으로 이식 파일을 관리합니다. 앱에서 따로 수정한 파일이 발견되면 자동 업데이트를 멈추고 충돌을 먼저 조정합니다.", icon: "/apps/aibi/features/feature-08.webp" },
    ],
    guide: [
  ...
  },
  {
    ...
    summary: "쇼츠 하나 끝날 때마다 손으로 넘기는 일이 귀찮다면. 자동쇼츠는 YouTube Shorts가 끝나면 다음 영상으로 자동 이동하고, 반복 재생도 알아채며, 확장 버튼 하나로 언제든 켜고 끄는 Chrome·네이버 웨일용 애드온(확장 프로그램)입니다.",
    theme: "coral",
    ...
    features: [
      { title: "끝까지 보면 다음 쇼츠로", body: "현재 Shorts의 재생이 끝나는 순간 다음 동영상 버튼을 사용해 자연스럽게 아래 영상으로 이동합니다.", icon: "/apps/autoshorts/features/feature-01.webp" },
      { title: "반복 재생도 놓치지 않게", body: "YouTube가 같은 영상을 자동 반복하도록 설정해도 종료 직전과 반복 시작점을 함께 감지합니다.", icon: "/apps/autoshorts/features/feature-02.webp" },
      { title: "YouTube 안에서 이동해도 계속", body: "홈이나 일반 영상에서 Shorts로 들어가는 화면 전환을 감지해 페이지를 새로 열지 않아도 준비합니다.", icon: "/apps/autoshorts/features/feature-03.webp" },
      { title: "원할 때 한 번에 멈춤", body: "도구 모음의 자동쇼츠 아이콘을 눌러 자동 넘김을 바로 켜거나 끌 수 있고 선택은 브라우저 안에 기억됩니다.", icon: "/apps/autoshorts/features/feature-04.webp" },
    ],
    guide: [
      { title: "ZIP 내려받기", body: "공식 GitHub Release에서 AutoShorts-0.1.4-source.zip을 내려받아 원하는 폴더에 압축을 풉니다." },
    ...
    progress: [
      { state: "done", title: "0.1.4 완전 소스 공개", body: "실행 파일과 모든 아이콘 원본, SVG 원본, 설치 안내, 패키지 정보와 자동화 동작 테스트 소스를 하나의 복원 패키지에 담았습니다." },
