...
export const apps: AppData[] = [
  {
    ...
    summary: "Claude·Gemini·Codex의 웹 창과 앱 안 CLI 채팅을 오가며 함께 배워 보세요. 답변이 이어지는 CLI 릴레이를 지켜보고, 팀 기록을 USB에 담는 Windows 포터블 앱입니다.",
    theme: "blue",
    icon: "/apps/aiplaygrand/icon.png",
    heroImage: "/apps/aiplaygrand/flow.svg",
    artwork: "bridge",
    platforms: [
      { name: "Windows x64", status: "공개", detail: "0.4.0 · 미리보기 · ZIP 포터블", url: releaseDownloadPath("AIplaygrand-Win"), downloadLabel: "Windows 미리보기 ZIP 받기", availabilityNote: "Windows 실기기·실제 로그인 이동 미검증. 코드 서명 신뢰 미검증." },
      { name: "Mac · Apple Silicon", status: "공개", detail: "0.4.0 · 미리보기 · 서명·Apple 공증 완료", url: releaseDownloadPath("AIplaygrand-Mac"), downloadLabel: "Mac 미리보기 DMG 받기", availabilityNote: "설치·첫 화면 확인 완료. 실제 서비스 로그인과 CLI 응답은 미검증입니다. Intel Mac용이 아닙니다." },
    ],
    features: [
      { title: "세 명에서 시작하는 우리 팀", body: "Claude 2명·Gemini 1명으로 시작하고 Codex를 포함해 팀원을 추가합니다. 웹 팀원별로 별도 로그인 창을 사용합니다." },
      { title: "세 AI와 앱 안에서 대화", body: "웹 창에서는 직접 질문을 보내고, CLI 채팅에서는 질문·후속 질문·중지·복사를 앱 안에서 사용합니다. 웹과 CLI는 별도로 로그인하며 대화가 자동 동기화되지는 않습니다." },
      { title: "지켜보는 CLI 릴레이", body: "앞 단계의 답을 다음 단계에 전달하는 3단계 릴레이와 실제 출력·진행 상태를 보여줍니다. 같은 서비스는 PC의 CLI 로그인 하나를 사용하며, 사용량 소진이나 오류가 나면 멈춥니다." },
      { title: "USB에 담는 암호화 보관함", body: "팀 기록·앱 웹창 쿠키·앱의 CLI 채팅과 릴레이 기록을 비밀번호로 보호합니다. 종료 후 앱과 Data 폴더를 함께 옮기세요. CLI 로그인 정보는 이동하지 않습니다." },
    ...
    guide: [
      ...
      { title: "웹 또는 CLI에서 실습", body: "앱은 API 키를 요구하지 않습니다. CLI는 공식 도구 설치·로그인과 이용권이 필요하며, 무료 웹 계정만으로 모든 CLI를 쓸 수 있는 것은 아닙니다. 웹 팀원 선택만으로 CLI 계정이 바뀌지 않습니다. 코드 제안을 확인하고 직접 실행하세요." },
      { title: "안전하게 이동", body: "저장하고 종료를 누르고 별도 CLI 터미널도 닫으세요. Windows의 하드웨어 안전하게 제거 후 USB를 옮기고, 다른 저장소에도 전체 폴더를 백업하세요." },
    ],
    progress: [
      { state: "done", title: "0.4.0 미리보기 공개", body: "Windows·Mac 패키지 빌드와 소스·산출물 무결성, 공개 다운로드를 확인했습니다. Mac은 서명·Apple 공증·설치 후 첫 화면까지 확인했습니다." },
      { state: "next", title: "실제 팀 실습 검증", body: "Windows 실기기 실행·실제 서비스 로그인과 CLI 응답·물리 USB 이동·로그인 복원은 미검증입니다. 새 PC에서는 재인증이 필요할 수 있습니다." },
    ],
    github: ["https://github.com/armsone/AIplaygrand-Win"],
    privacy: ["팀 기록·앱 웹창 쿠키·앱의 CLI 채팅과 릴레이 기록은 암호화 보관함에 저장합니다. 비밀번호를 아는 사람은 기록과 저장된 웹 세션을 사용할 수 있습니다. 전송하지 않은 CLI 초안은 저장하지 않습니다.", "CLI 자체 인증·설정·사용 이력은 PC에서 각 도구가 관리하며 보관함에 포함되지 않습니다. 다운로드·내보낸 JSON·CLI 작업 파일과 이전 버전 원본도 보관함 암호화 대상이 아닙니다.", "다른 브라우저의 로그인 정보를 가져오거나 사용량 제한을 우회하는 자동 계정 전환은 하지 않습니다. 웹 쿠키 복원은 로그인 유지를 보장하지 않습니다. 웹 이어받기는 질문 복사와 창 열기까지만 돕고, 사용자가 직접 전송합니다.", "사용자가 전송하거나 CLI 채팅·릴레이를 시작하면 질문과 필요한 앞 단계 결과가 해당 공식 AI 서비스로 전달됩니다. 각 서비스 정책이 적용됩니다. 악성코드가 있는 PC나 운영체제의 임시 기록까지 보호하는 무흔적 실행은 아닙니다."],
  },
  {
    slug: "cleanusb",
    name: "클린USB",
  ...
  },
  {
    ...
    summary: "낮에는 플립시계·날씨와 함께 빠방의 현재 채널을 작은 영상창으로 즐기고, 밤에는 화면을 잠그거나 다른 앱으로 나가도 자동으로 매이트 모드가 이어져 수면 소리 후보를 기기 안에 기록합니다. 조용했던 밤과 감지 실패도 분명히 구분합니다.",
    theme: "amber",
  ...
  },
  {
    ...
    summary: "가까운 음식점 13곳 중 공공기관의 식사 이용 기록이 확인된 곳을 먼저 제안합니다. 최근 18개월의 기록을 담은 11,091곳 명단으로 오늘의 한 끼를 고르고, 이용 기록과 출처도 확인하세요.",
    theme: "coral",
