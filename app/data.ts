...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    platforms: [
      ...
      { name: "macOS", status: "공개", detail: "2.0.21 (202609071030) · macOS 10.15+ · Universal · Apple 공증 완료 · CloudKit Production 서명", url: releaseDownloadPath("CCMB"), downloadLabel: "DMG 다운로드", checksum: "40174ba1e9ac17f7d7b39b9cf3cd4e10b6ec0ff25a942e617c3f2d549947f27d" },
    ],
    features: [
