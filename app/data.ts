...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    tagline: "개발 도구가 빌려 쓴 공간을, 안전하게 돌려놓습니다.",
    summary: "AI·개발 작업 뒤 남은 Xcode 시뮬레이터와 작업 산출물을 찾아 위험도와 이유를 설명하고, 사용자가 고른 항목만 다시 확인한 뒤 정리하는 macOS 메뉴 막대 앱입니다.",
    theme: "blue",
    ...
    platforms: [
      {
        name: "macOS",
        status: "공개",
        detail: "v1.1.0 · macOS 13+ · Apple Silicon · Apple 공증 완료",
        url: "https://github.com/armsone/BackToNormal/releases/download/v1.1.0/BackToNormal-1.1.0.dmg",
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "74394081025df706f1bf96400224416147e05d00e6f3d8540a8c12b929c3168b",
      },
    ],
    features: [
      ...
      { title: "실행 직전 다시 확인", body: "경로, 심볼릭 링크, 파일 식별 정보와 시뮬레이터 상태를 조치 직전에 다시 검증해 바뀐 대상은 건너뜁니다." },
    ...
    guide: [
      ...
      { title: "남은 자원 찾기", body: "메뉴 막대에서 자세히 보기를 열고 새로고침해 시뮬레이터와 오래된 개발 산출물 후보를 확인합니다." },
      { title: "이유와 위험도 확인", body: "각 항목의 경로, 예상 확보 용량, 감지 이유와 초록·노랑·빨강 위험도를 읽습니다." },
    ...
    progress: [
      ...
      { state: "done", title: "서명·공증 DMG 공개", body: "Developer ID 서명과 Apple 공증을 마친 v1.1.0 DMG를 GitHub Releases에 공개" },
      { state: "next", title: "프로세스·포트 원상복구", body: "Gradle·Kotlin·Node와 로컬 개발 서버를 작업 세션별로 구분하는 안전 규칙 준비" },
    ],
    screenshots: [
  ...
  },
  {
    ...
    summary: "가족 기기를 QR로 묶고 조용한 알림·띵동 알림·목소리 전달을 보내는 iPhone·Android 가족 호출 앱입니다. 가까운 기기는 직접 연결하고, iPhone은 개인 NAS와 Apple 푸시로 원거리 수신까지 이어집니다.",
    theme: "coral",
    icon: "/apps/button/icon.png",
    artwork: "phones",
    platforms: [
      { name: "iPhone", status: "완료", detail: "1.0 (13) · iOS 17+", availabilityNote: "TestFlight 업로드 완료" },
      {
        name: "Android",
        status: "공개",
        detail: "1.0 (13) · Android 8.0+",
        url: "https://github.com/armsone/button-Android/releases/download/v1.0.0/Button-Android-v1.0-build13.apk",
        downloadLabel: "Android APK 바로 받기",
        checksum: "05da916dbf24c753a7f5ceeef581255be3977aac8c2ee2007014d0b78086b29f",
      },
    ],
    features: [
      ...
      { title: "iPhone 잠금화면 수신", body: "iPhone은 Apple 푸시 알림을 사용해 앱이 화면에 없거나 잠겨 있을 때도 호출 알림과 소리를 전달합니다." },
      { title: "근거리 연결과 원거리 중계", body: "가까운 기기는 직접 연결하고, 개인 Synology NAS 중계 서버로 iPhone의 원거리 호출을 이어줍니다. Android 원격 수신은 준비 중입니다." },
    ...
    guide: [
      ...
      { title: "알림 권한 확인", body: "iPhone 또는 Android 설정에서 버튼 앱의 알림과 소리를 허용합니다. Android는 앱이 실행 중일 때의 Bluetooth 수신을 기준으로 합니다." },
    ],
    progress: [
      ...
      { state: "done", title: "원거리 푸시 중계", body: "Synology NAS 서버와 APNs를 연결해 잠금·백그라운드 호출 지원" },
      { state: "done", title: "가족 iPhone 실기기 검증", body: "네 대의 iPhone에 빌드 13 설치와 자동 테스트 완료" },
      { state: "done", title: "Android 1.0 공개", body: "휴대전화·태블릿 화면과 개별 전송·확인 흐름을 검증하고 build 13 APK를 GitHub Releases에 공개" },
      { state: "active", title: "TestFlight 처리", body: "1.0 (13) 업로드 완료, Apple의 빌드 처리 결과 대기" },
      { state: "next", title: "Android 원격 수신", body: "FCM 제공자와 서버 수신 경로, 백그라운드 Bluetooth 수명주기 보강 예정" },
    ],
    screenshots: [
    ...
    privacy: [
      ...
      "iPhone 푸시 알림용 기기 토큰은 해당 가족 공간의 원거리 호출 전달에만 사용합니다.",
