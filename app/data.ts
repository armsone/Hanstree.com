...
export const apps: AppData[] = [
  {
    ...
    platforms: [
      ...
      { name: "Mac용 NasFinder", status: "TestFlight", detail: "2.1.0 · Apple Silicon · iPhone·iPad 호환 앱", availabilityNote: "같은 TestFlight 빌드 · 처리 완료" },
      {
        name: "Android",
        status: "공개",
        detail: "2.1.0 · 빌드 202608251045 · 내부 코드 340486 · Android 8.0+",
        url: releaseDownloadPath("NasFinder-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "e27b39a18499471c0f4b9137fa642ea4c8a847baa0600f6ff48a57ce56737feb",
    ...
    features: [
      ...
      { title: "파일과 폴더를 함께 보는 Super Thumbnail", body: "파일 미리보기뿐 아니라 폴더 안의 파일·하위 폴더를 최대 9칸 모아 한눈에 보여줍니다. 살색 비율이 높은 모아보기에는 2pt 블러를 적용하며, Apple과 Android NasFinder가 같은 NAS Vault 결과를 읽습니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Android 2.1.0 공개", body: "제품 2.1.0 · 빌드 202608251045 · 내부 코드 340486의 서명 APK를 GitHub Releases에 공개" },
