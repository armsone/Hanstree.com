...
export const apps: AppData[] = [
  {
    ...
    platforms: [
      ...
      { name: "Mac용 NasFinder", status: "TestFlight", detail: "2.1.0 · Apple Silicon · iPhone·iPad 호환 앱", availabilityNote: "같은 TestFlight 빌드 · Apple 처리 중" },
      {
        name: "Android",
        status: "공개",
        detail: "2.1.0 · build 202608251045 · APK code 340486 · Android 8.0+",
  ...
  },
  {
    ...
    platforms: [
      ...
      { name: "Mac", status: "TestFlight", detail: "2.1.0 · Apple Silicon · iPad 앱 호환 모드", availabilityNote: "같은 TestFlight 빌드 · 처리 완료" },
      {
        name: "Android",
        status: "공개",
        detail: "2.1.0 · build 202608250313 · APK code 340033 · Android 8.0+",
  ...
  },
  {
    ...
    platforms: [
      ...
      },
      {
        ...
        status: "공개",
        detail: "2.1.0 · build 202608251027 · APK code 340467 · Android 8.0+",
