...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "빈티지 데님을 여러 각도에서 촬영하면 한양과 아이비가 선명한 단서를 골라 분석합니다. 한국·일본 예상 가격과 판매 순수익, 시장 간 차익을 확인하고 결과를 나만의 아카이브에 남길 수 있습니다.",
    theme: "blue",
    ...
    features: [
      ...
      { title: "한국과 일본의 예상가를 나란히", body: "사진에서 확인한 브랜드, 모델, 연대와 상태를 근거로 한국 원화와 일본 엔화의 예상 판매가 범위를 함께 보여줍니다." },
    ...
    guide: [
      ...
      { title: "시장과 수익 비교", body: "한국·일본 예상 판매가와 순수익, 시장 간 예상 차익을 보고 사진 근거와 신뢰 수준을 함께 확인합니다." },
