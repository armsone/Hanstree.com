  ...
  },
  {
    ...
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.5.0 · 외부 베타 심사 대기 · iOS·iPadOS 17+", availabilityNote: "2.5.0 심사 제출 완료 · 승인 전에는 기존 공개 베타로 참여 가능" },
      {
        name: "macOS",
        status: "공개",
        detail: "2.5.0 · macOS 14+ · Apple 공증 완료",
        url: releaseDownloadPath("S.tand-macOS"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "a1ad18bfe2af0541aba28f9651a0333b9e92692c3b7bfa713a36272a14e7729a",
      },
      {
        name: "Android · Google TV",
        status: "공개",
        detail: "2.5.0 · Android 8.0+",
        url: releaseDownloadPath("S.tand-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "6913cadbd2ab6368e5b888e97122a61a0b420804ece9c37a3a8f8c5b3a5a6030",
        availabilityNote: "Android·Google TV용 2.5.0 APK 공개 · 기존 설정과 기록을 유지하는 업데이트",
      },
    ],
    features: [
      { title: "빠방 9개 채널", body: "음악 목록 맨 앞에서 빠방을 선택하고 CCM·라운지·베드룸 등 9개 채널을 즐깁니다. 작은 영상창 옆의 큰 정지·다음·닫기 버튼으로 재생을 제어합니다." },
      { title: "내 자리에 두는 미니플레이어", body: "처음에는 빠방 버튼 아래에 나타나고, 원하는 곳으로 옮기면 다음 실행에도 그 위치를 기억합니다. 테마와 어울리는 배경은 이동 버튼을 눌러 10·35·60·85·100% 진하기로 바꿉니다." },
