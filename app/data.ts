...
const appCatalog: AppData[] = [
  {
    ...
    summary: "아이디어가 떠오를 때마다 어디서든 브라우저를 열어 맡기고 싶다면. Hanstree-AI는 내 NAS에 둔 개인용 작업실입니다. 아이디어마다 프로젝트를 만들고, AI 팀장에게 말로 요청하면 진행과 결과가 차곡차곡 쌓입니다. 지금은 주인 한 사람만 쓰는 0.2.1 개발 단계이며, 누구나 가입해 쓰는 공개 서비스가 아닙니다.",
    theme: "violet",
    icon: "/apps/hanstree-workroom/icon-019.png",
    heroImage: "/apps/hanstree-workroom/icon-019.png",
    screenshots: [{ src: "/apps/hanstree-workroom/screens/login-019.png", alt: "Hanstree-AI 0.2.1 실제 NAS 로그인 화면 · 로그인 전 상태", layout: "phone" }],
    artwork: "bridge",
    platforms: [
      {
        name: "Web · 개인용 웹 작업실",
        status: "개발 중",
        detail: "0.2.1 · 소유자 1인 전용 · NAS에서 실행",
    ...
    features: [
      { title: "프로젝트 순서 정리", body: "프로젝트 목록을 길게 눌러 원하는 위치로 옮기고, 아이디어 작업 순서를 작업실에 맞게 정리합니다.", icon: "/apps/trackpadguard/features/feature-05.webp" },
      ...
      { title: "팀장에게 말로 요청", body: "Codex 팀장에게 말하듯 요청합니다. 팀장은 필요하면 NAS에 설치된 Claude와 Gemini를 불러 함께 일합니다. 요청할 때 모델과 추론 강도를 고를 수 있습니다. 실제 AI의 읽기 전용 응답은 0.1.0에서 확인했습니다.", icon: "/apps/starmanager/features/feature-02.webp" },
      ...
      { title: "주인 비밀번호로 보호", body: "작업실 비밀번호로 접근을 제한합니다. 프로젝트를 삭제할 때는 현재 비밀번호를 다시 확인하고, 폴더 삭제 여부는 따로 선택합니다. 대화와 파일은 내 NAS에 보관하고, 연결해 둔 AI 계정으로 작업합니다.", icon: "/apps/nasfinder/features/feature-08.webp" },
    ],
    guide: [
      ...
      { title: "팀장에게 요청", body: "모델과 추론 강도를 고르고 하고 싶은 일을 말로 적어 보냅니다. 앞선 작업이 끝나야 다음 작업이 시작됩니다." },
    ...
    progress: [
      ...
      { state: "done", title: "0.1.9 NAS 배포·로그인 화면 확인", body: "NAS 런타임 0.1.9를 배포했고 외부 HTTPS 주소에서 실제 로그인 화면을 확인했습니다. 새 기능은 소스 기능과 독립 검토로 확인했으며, 전체 기능의 실사용 재검증은 아직 하지 않았습니다." },
