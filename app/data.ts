...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    platforms: [
      ...
      },
      {
        ...
        status: "공개",
        detail: "2.3.2 · 빌드 202608282205 · 내부 코드 345485 · Android 8.0+",
        url: releaseDownloadPath("S.tand-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "72d73a995a5229aace05abb8647b34bd3517232ba6aed2243a13cf2869e83545",
        availabilityNote: "Google TV QR 프리셋 전송 확인 · 선택선 5초 자동 숨김과 홈 뒤로가기 종료 수정 · 2.3.2 TV 실기기 재확인 대기",
      },
    ],
    features: [
      ...
      { title: "Google TV 리모컨 지원", body: "10-foot 가로 화면에서 D-pad로 음악·설정·테마·밝기·시계 크기를 조작합니다. 선택선은 마지막 조작 5초 뒤 화면에서만 사라지고, 홈에서 뒤로가기를 누르면 앱이 정상 종료됩니다." },
    ...
    guide: [
      ...
      { title: "Google TV에서", body: "설정의 음악 항목에서 라디오 가져오기·내보내기 → 휴대전화에서 받기를 열고, 같은 Wi-Fi의 휴대전화로 QR을 스캔해 S.tand 라디오 파일을 보냅니다. 방향키 조작을 멈추면 선택선은 5초 뒤 자연스럽게 사라집니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Android·Google TV 2.3.2 공개", body: "QR 라디오 프리셋 전송, HTTP·HTTPS 주소, 5초 선택선 숨김과 홈 뒤로가기 종료를 담은 빌드 202608282205 · 내부 코드 345485 APK 공개" },
  ...
  },
  {
    ...
    artwork: "phones",
    platforms: [
      { name: "iPhone · iPad", status: "TestFlight", detail: "2.3.0 · 빌드 202608282124 · iOS·iPadOS 18+", availabilityNote: "2.3.0 Public Beta 심사 대기 · 공개 링크에서는 승인된 이전 빌드 테스트 가능" },
      {
        name: "Android",
        status: "공개",
        detail: "2.3.0 · 빌드 202608282124 · 내부 코드 345444 · Android 8.0+",
        url: releaseDownloadPath("StarManager-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "cb3b490e7bcc06e77bb085936c77b873976cc2efba178a54b85989faeb7078d3",
        availabilityNote: "휴대전화·태블릿·Google TV 지원 · 기존 설치를 유지하는 업데이트 APK 공개",
      },
    ],
    features: [
      { title: "미디어부터 바로 시작", body: "사진이나 영상을 먼저 고르고 그 장면을 보며 글을 씁니다. 미디어 없이 글부터 시작하거나 사진만 AI에 맡겨도 됩니다." },
    ...
    guide: [
      ...
      { title: "AI로 초안 만들기", body: "Gemini·ChatGPT·Claude·기기 AI 중 하나를 고른 뒤 해당 만들기 버튼을 누릅니다. 외부 AI는 화면 뒤에서 자동 입력·전송되며 진행 상태는 스튜디오에서 확인합니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Android 2.3.0 공개", body: "제품 2.3.0 · 빌드 202608282124 · 내부 코드 345444의 휴대전화·태블릿·Google TV 지원 APK를 GitHub Releases에 공개" },
      { state: "done", title: "iPhone 2.3.0 실기기 설치", body: "대표 iPhone에 2.3.0 (202608282124)을 교체 설치하고 버전을 확인" },
      { state: "active", title: "iOS·iPadOS 2.3.0 Public Beta 심사", body: "build 202608282124를 Public Beta 그룹에 추가하고 테스터 알림과 Beta App Review를 제출했으며 기존 공개 테스트 링크는 유지" },
    ...
    matchup: {
      ...
      note: "최신 iPhone·Android 실기기 캡처로 접힌 첫 화면과 펼친 글 스타일 설정을 짝지어 확인했으며, 화면·상태·상호작용 증거 6개가 모두 검증을 통과했습니다.",
    },
  },
  {
  ...
  },
  {
    ...
    platforms: [
      {
        ...
        status: "완료",
        detail: "AIBI 0.2.1 · 양 플랫폼 이식·빌드·동기화 검증 완료",
    ...
    features: [
      ...
      { title: "사진도 순서대로 함께", body: "사진만 또는 사진과 글을 함께 전달하고, 여러 사진은 선택 순서와 대표 항목을 유지해 제공자별 첨부 흐름으로 보냅니다." },
    ...
    progress: [
      { state: "done", title: "독립 기준 프로젝트 0.2.1", body: "공통 계약, 제공자 변화 대응 절차, Apple·Android 참조 엔진과 StarManager 배포 스냅샷을 독립 기준 원본으로 구성" },
