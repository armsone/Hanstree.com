...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    artwork: "phones",
    platforms: [
      { name: "iPhone", status: "완료", detail: "1.2 (18) · iOS 17+", availabilityNote: "TestFlight 업로드 완료" },
      {
        name: "Android",
        status: "공개",
        detail: "1.2.1 (19) · Android 8.0+",
        url: "https://github.com/armsone/button-Android/releases/download/v1.2.1/Button-Android-v1.2.1-build19.apk",
        downloadLabel: "Android APK 바로 받기",
        checksum: "03989f8b2b06809ec7d8a7d3bd941fff11826dc91e45a045952411945d051ed3",
      },
    ],
    features: [
