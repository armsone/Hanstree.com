...
const appCatalog: AppData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "더 안정적인 Codex 사용량", body: "Codex CLI가 이미 로그인한 세션을 이용해 주간·Spark 한도, 초기화 쿠폰과 크레딧을 직접 읽어 표시합니다.", icon: "/apps/ccmb/features/feature-06.webp" },
      { title: "한 줄로 온전히 보이는 갱신 기록", body: "중복 서비스 이름과 말줄임표 없이 Spark·Fable을 포함한 갱신당 사용량을 한 줄로 표시하고, 막대 위 시각은 초 없는 24시간제로 보여 줍니다.", icon: "/apps/starmanager/features/feature-07.webp" },
