...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "가족 기기를 QR로 여러 공간에 묶고 톡톡·띵동·소리와 긴급 사이렌을 보내는 iPhone·Android 가족 호출 앱입니다. 가까운 기기는 직접 연결하고, 개인 NAS가 iPhone의 APNs와 Android의 FCM을 함께 중계합니다.",
    theme: "coral",
    icon: "/apps/button/icon.png",
    artwork: "phones",
    platforms: [
      { name: "iPhone", status: "완료", detail: "1.2 (17) · iOS 17+", availabilityNote: "TestFlight 업로드 완료" },
      {
        name: "Android",
        status: "공개",
        detail: "1.2.0 (18) · Android 8.0+",
        url: "https://github.com/armsone/button-Android/releases/download/v1.2.0/Button-Android-v1.2.0-build18.apk",
        downloadLabel: "Android APK 바로 받기",
        checksum: "4b1c36e63fe869a572bd5d123aae644a64118a7eacf4eafb49f8b029b4d4aa68",
      },
    ],
    features: [
      { title: "톡톡에서 사이렌까지", body: "톡톡은 탭하면 소리 없이 전해지고, 5초간 누르면 보낸 기기는 조용한 채 상대 기기에 강력한 사이렌을 보냅니다." },
      { title: "녹음하고 확인해서 보내기", body: "소리를 녹음한 뒤 보내기 또는 취소를 한 번 더 고릅니다. 받는 사람은 앱에서 바로 듣고 최근 기록에서 다시 들을 수 있습니다." },
      { title: "한 사람 또는 모두에게", body: "원거리에 있는 가족까지 받을 사람 목록에 표시합니다. 이름을 선택해 한 사람에게 보내거나 선택 없이 모두에게 보냅니다." },
      ...
      { title: "부모와 자녀 모두 소리 전송", body: "부모와 자녀 모두 톡톡·띵동·소리를 보낼 수 있고, 자녀의 연속 호출만 10초 동안 제한합니다." },
    ],
    guide: [
      ...
      { title: "받을 사람 선택", body: "모두에게 보내려면 선택하지 않고, 한 사람에게만 보내려면 가까이 있거나 원거리에 있는 가족 이름을 누릅니다." },
      { title: "호출 보내기", body: "톡톡·띵동·소리 중 하나를 누릅니다. 톡톡을 5초간 누르면 사이렌을 보내고, 소리는 녹음을 마친 뒤 보내기를 한 번 더 확인합니다." },
    ...
    progress: [
      ...
      { state: "done", title: "세 가지 호출과 확인", body: "톡톡·띵동·소리, 개별 전송, 20개 최근 기록과 미확인 인원 표시 구현" },
      { state: "done", title: "원거리 푸시 중계", body: "Synology NAS에서 APNs와 FCM을 함께 운영해 iPhone·Android 잠금·백그라운드 호출 지원" },
      { state: "done", title: "가족 실기기 설치", body: "가족 iPhone 세 대에 iOS 1.2 build 17, SM-F968N에 Android 1.2.0 build 18 설치와 실행 확인" },
      { state: "done", title: "Android 1.2.0 공개", body: "여러 공간·확인 인원·자녀 소리 전송·새 버튼과 문구를 반영한 서명 build 18 APK와 체크섬을 GitHub Releases에 공개" },
      { state: "active", title: "TestFlight 처리", body: "1.2 (17) 업로드 완료, Apple의 빌드 처리 결과 대기" },
