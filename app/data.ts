...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "낮에는 플립시계·날씨와 함께 빠방 9개 채널을 작은 영상창으로 즐기고, 밤에는 화면을 잠그거나 다른 앱으로 나가도 자동으로 매이트 모드가 이어져 수면 소리 후보를 기기 안에 기록합니다. 조용했던 밤과 감지 실패도 분명히 구분합니다.",
    theme: "amber",
    icon: "/apps/stand/icon.png",
    artwork: "clock",
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.5.0 · 외부 베타 심사 대기 · iOS·iPadOS 17+", availabilityNote: "2.5.0 심사 제출 완료 · 승인 전에는 기존 공개 베타로 참여 가능" },
      {
        name: "macOS",
        status: "공개",
        detail: "2.5.1 · macOS 14+ · Apple 공증 완료",
        url: releaseDownloadPath("S.tand-macOS"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "8a224a57ad7a27381f834af18d230eef6a03fd40660d16168035bbc93289325f",
      },
      {
        name: "Android · Google TV",
        status: "공개",
        detail: "2.5.1 · Android 8.0+",
        url: releaseDownloadPath("S.tand-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "2bf6de4c9c61041a94a57f1a6708db488acf01ec32cc6af30f518fe8ac84a28a",
        availabilityNote: "Android·Google TV용 2.5.1 APK 공개 · 기존 설정과 기록을 유지하는 업데이트",
      },
    ],
    features: [
      { title: "빠방 9개 채널", body: "음악 목록 맨 앞에서 빠방을 선택하고 CCM·라운지·베드룸 등 9개 채널을 즐깁니다. 왼쪽은 재생·정지, 오른쪽은 다음 곡이며 길게 누르면 재생목록을 고릅니다." },
    ...
    guide: [
      { title: "빠방 듣기", body: "음악 목록 맨 앞의 빠방 버튼을 눌러 채널을 고릅니다. 미니창의 사방 화살표를 끌면 이동하고, 가볍게 누르면 배경 진하기가 바뀝니다. 오른쪽 버튼으로 정지하거나 다음 곡으로 넘기고 창을 닫습니다. 공식 YouTube 영상을 화면에 표시하며 재생합니다." },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "취향별 세 카테고리 추가", body: "먹방·맛집 채널, 캠핑·차박 채널, 캠핑·차박·먹방을 제외한 순수 여행 채널을 각각 따로 골라 볼 수 있습니다." },
    ...
    progress: [
      { state: "done", title: "먹방·캠핑·순수 여행 카테고리 추가", body: "선호 채널 기반의 먹방과 캠핑·차박, 그리고 캠핑·차박·먹방을 제외한 순수 여행 쇼츠 카테고리를 추가했습니다." },
