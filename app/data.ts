...
const appCatalog: AppData[] = [
  {
    ...
    features: [
      ...
      { title: "세 AI와 앱 안에서 대화", body: "Claude·Gemini 웹 자동 전송을 지원하며 Codex 클라우드 웹은 창 열기를 지원합니다. 앱 안 CLI 채팅에서는 질문·후속 질문·중지·복사를 사용합니다." },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "메뉴바에서 꺼내기까지", body: "메뉴바에서 정리 창을 열거나 드라이브를 바로 꺼낼 수 있습니다. 작업이 끝나지 않았거나 오류가 있으면 자동 꺼내기를 진행하지 않습니다." },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "가까운 날짜를 바로 읽는 24시간 표기", body: "Mac과 iPhone 모두 초기화 날짜가 오늘·내일·모레면 말로 표시하고, 그 이후에는 9/7(월) 19:00처럼 요일·24시간 형식으로 보여 줍니다. Gemini가 한국어·영어 문장으로 주는 시각도 같은 규칙으로 정리합니다." },
      ...
      { title: "더 안정적인 Codex 사용량", body: "Codex CLI가 이미 로그인한 세션을 이용해 주간·Spark 한도, 초기화 쿠폰과 크레딧을 직접 읽어 표시합니다." },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "오늘의 말씀과 찬양", body: "많이 찾는 교회와 목사의 공식 채널을 먼저 확인하면서, 지역 교회의 최신 설교와 찬양도 함께 발견합니다." },
      { title: "목사님 발견 이어가기", body: "목사님 페이지 하단에서 다른 목회자 8명을 새롭게 추천받고, 한 사람의 사역 기록을 계속 둘러봅니다." },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "추천의 근거를 직접 확인", body: "공공기관 이용 기록 표시를 보고 식당을 고른 뒤 결제일과 공식 원문을 확인하세요. 주소가 빠진 일부 기록은 기관 주변의 공식 사업장 정보로 보완했습니다." },
      ...
      { title: "점심 전에 가볍게 알림", body: "점심시간과 알림 시각을 정하고, 휴일 제외를 켜면 토·일요일과 한클립 달력의 한국 공휴일에는 알리지 않습니다. Apple은 다음 60회까지 예약하고 앱을 열 때 갱신합니다. 새 설정은 Mac·Android에서 제공하며 최신 iPhone·iPad 빌드는 외부 베타 심사 중입니다." },
    ],
    guide: [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "같은 곡은 덜 나오게", body: "최근 재생 영상 2,500개를 기억하고 아직 듣지 않은 곡부터 섞습니다. 확인 가능한 곡명은 다른 영상으로 올라온 같은 곡도 묶으며, 후보를 모두 들었을 때만 오래전에 들은 것부터 다시 준비합니다. 모음 영상 내부의 개별 곡이나 불명확한 제목까지 식별하지는 않습니다." },
      { title: "1분 안에 돌아와 이어 보기", body: "다른 탭·앱으로 이동하면 일시정지합니다. 페이지가 유지되고 1분 안에 돌아오면 같은 위치에서 재생을 요청합니다. 자동 재생이 허용되지 않거나 늦게 돌아오면 이어듣기 버튼을 사용합니다." },
      { title: "TV에서는 휴대전화로 간단히 연결", body: "Google TV 화면의 QR 코드나 기기 코드를 휴대전화에서 승인하고, 다음 새 영상 갱신부터는 현재 기기에 저장된 연결을 다시 사용합니다." },
      { title: "취향별 세 카테고리 추가", body: "스타크래프트를 포함한 게임 채널, 먹방·맛집 채널, 캠핑·차박·먹방을 제외한 순수 여행 채널을 각각 따로 골라 볼 수 있습니다." },
