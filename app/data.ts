...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "키 입력이 시작되면 트랙패드의 커서 이동·클릭·스크롤을 막고, 사용자가 지정한 물리적 영역을 새로 터치하면 즉시 해제하는 macOS 메뉴 막대 앱입니다.",
    theme: "blue",
    icon: "/apps/trackpadguard/icon.png",
    artwork: "trackpad",
    platforms: [
      { name: "macOS", status: "공개", detail: "v0.1.2 · macOS 13+ · Universal", url: "https://github.com/armsone/TrackpadGuard/releases/tag/v0.1.2", downloadLabel: "DMG 다운로드" },
    ],
    features: [
    ...
    progress: [
      ...
      { state: "done", title: "서명·공증 배포", body: "Developer ID 서명, Apple 공증과 v0.1.2 DMG 공개 완료" },
