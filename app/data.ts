...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    artwork: "clock",
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.5.4 · 외부 베타 심사 대기 · iOS·iPadOS 17+", availabilityNote: "2.5.4 업로드·Public Beta 그룹 추가·심사 제출 완료 · 새 빌드 외부 제공은 Apple 승인 후" },
      {
        name: "macOS",
        status: "공개",
        detail: "2.5.4 · macOS 14+ · Apple 공증 완료",
      ...
      },
      {
        ...
        status: "공개",
        detail: "2.5.5 · Android 8.0+",
        url: releaseDownloadPath("S.tand-Android"),
        downloadLabel: "Android APK 바로 받기",
        availabilityNote: "Android·Google TV용 2.5.5 APK 공개 · 다른 앱에 잠깐 다녀와도 빠방을 1분 안에 이어듣기 · 기존 설정과 기록 유지",
      },
    ],
    features: [
      { title: "빠방의 현재 채널", body: "음악 목록 맨 앞에서 빠방을 선택하면 서버에 준비된 채널이 바로 나타납니다. 왼쪽은 재생·정지, 오른쪽은 다음 곡이며 길게 누르면 재생목록을 고릅니다." },
      { title: "덜 겹치는 빠방 재생목록", body: "최근에 들은 영상과 제목으로 확인한 같은 곡을 피하고, 아직 듣지 않은 곡부터 섞습니다. 후보를 모두 들으면 가장 오래전에 들은 곡부터 다시 준비합니다." },
      { title: "잠깐 다녀와도 같은 위치에서", body: "다른 앱으로 이동하면 영상을 일시정지하고 미니플레이어를 1분 동안 유지합니다. 1분 안에 돌아오면 같은 영상의 같은 위치에서 이어듣기를 요청합니다. Mac 2.5.4·Android 2.5.5 공개, iPhone·iPad 2.5.4는 외부 심사 대기 중입니다." },
