...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "음악 채널과 위젯", body: "홈의 두 버튼에 Apple Music, Apple Music Classical 또는 인터넷 라디오를 배치합니다. Music 앱이 이미 재생 중이면 S.tand를 다시 열어도 현재 곡과 재생 상태를 이어 받고, 긴 곡 제목은 패널에서 왼쪽으로 흐릅니다." },
    ...
    guide: [
      ...
      { title: "음악 채널", body: "홈의 두 버튼에 원하는 음악 채널을 정합니다. Apple Music은 Music 앱의 현재곡과 재생·일시정지 상태를 먼저 이어 받고, 이어 들을 곡이 없으면 보관함 무작위 재생과 Apple 추천을 사용합니다." },
