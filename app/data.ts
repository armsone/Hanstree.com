...
const appCatalog: AppData[] = [
  ...
  },
  {
    ...
    summary: "아이디어가 떠오를 때마다 어디서든 브라우저를 열어 맡기고 싶다면. Hanstree-AI는 내 NAS에 둔 개인용 작업실입니다. 아이디어마다 프로젝트를 만들고, AI 팀장에게 말로 요청하면 진행과 결과가 차곡차곡 쌓입니다. 지금은 주인 한 사람만 쓰는 0.2.0 개발 단계이며, 누구나 가입해 쓰는 공개 서비스가 아닙니다.",
    theme: "violet",
    ...
    platforms: [
      {
        name: "Web · 개인용 웹 작업실",
        status: "개발 중",
        detail: "0.2.0 · 소유자 1인 전용 · NAS에서 실행",
