...
const appCatalog: AppData[] = [
  {
    ...
    summary: "아이디어가 떠오를 때마다 어디서든 브라우저를 열어 맡기고 싶다면. Hanstree-AI는 내 NAS에 둔 AI 작업실입니다. 아이디어마다 프로젝트를 만들고, AI 팀장에게 말로 요청하면 진행과 결과가 차곡차곡 쌓입니다. 0.3.64에서는 마스터가 작업실 자체를 관리하고, 긴 프로젝트 목록과 이전 요청도 편하게 이어갈 수 있습니다. 소유자가 허용한 계정으로 사용하는 비공개 작업실입니다.",
    theme: "violet",
    ...
    platforms: [
      {
        name: "Web · 개인용 웹 작업실",
        status: "개발 중",
        detail: "0.3.64 · 허용된 계정으로 이용 · NAS에서 실행",
    ...
    features: [
      { title: "길어진 목록도 편하게", body: "왼쪽 프로젝트 목록이 화면보다 길어지면 스크롤해 끝까지 볼 수 있습니다. 터치로 목록을 넘기고, 길게 눌러 순서를 바꿉니다.", icon: "/apps/trackpadguard/features/feature-05.webp" },
    ...
    progress: [
      ...
      { state: "done", title: "0.3.64 NAS 반영·소스 릴리즈", body: "NAS 실행본과 릴리즈 소스의 일치를 확인했습니다. 마스터 관리 대화, 기본 모델·추론 강도, 다시 요청의 입력 복원·복사, 프로젝트 목록 스크롤을 운영 화면에서 확인했습니다. 전체 기능을 재검증한 것은 아닙니다." },
