...
export const apps: AppData[] = [
  {
    ...
    artwork: "files",
    platforms: [
      { name: "iPhone · iPad", status: "TestFlight", detail: "2.1.1 (202608251305) · iOS·iPadOS 17+", availabilityNote: "TestFlight 업로드 완료 · 처리 중" },
      { name: "Mac용 NasFinder", status: "TestFlight", detail: "2.1.1 · Apple Silicon · iPhone·iPad 호환 앱", availabilityNote: "같은 TestFlight 빌드 · 처리 중" },
      {
        name: "Android",
        status: "공개",
    ...
    features: [
      ...
      { title: "파일과 폴더를 함께 보는 Super Thumbnail", body: "파일 미리보기뿐 아니라 폴더 안의 파일·하위 폴더를 최대 9칸 모아 한눈에 보여줍니다. Apple과 Android NasFinder는 NAS Vault에 준비된 Super Thumbnail이 있으면 휴대폰에서 만든 일반 썸네일보다 먼저 사용합니다." },
  ...
  },
  {
    ...
    platforms: [
      {
        name: "macOS",
        status: "공개",
        detail: "2.1.3 (202608251602) · macOS 14+ · Apple Silicon·Intel · Apple 공증 완료",
        url: releaseDownloadPath("NasFinder-Super-Thumbnail"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "c14daa621a8210a3a3785a9d59f1d3439dada929ae7792caa670fabe3c38c507",
      },
    ],
    features: [
      ...
      { title: "미리보는 재미까지 크게", body: "선택한 폴더의 기존 썸네일과 새로 만들어지는 결과를 앱 안에서 확인합니다. 다음 업데이트에서는 가로 손잡이를 아래로 끌수록 미리보기와 이미지가 함께 커지고, 고른 크기도 기억합니다. 새로 만든 항목이 가장 왼쪽에 나타납니다." },
    ...
    guide: [
      ...
      { title: "생성과 확인", body: "이어하기로 남은 작업을 계속하거나 새로하기로 Vault 썸네일만 다시 만듭니다. 미리보기는 필요할 때 접거나 펼칠 수 있습니다." },
    ...
    progress: [
      ...
      { state: "active", title: "크기 조절 미리보기 준비", body: "아래로 끌면 이미지가 함께 커지는 가로 미리보기와 선택 크기 기억 기능을 다음 Mac 업데이트로 검증 중" },
