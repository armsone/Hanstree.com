...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    tagline: "Codex·Claude·Gemini usage, reset status, and credit refresh in one glance.",
    summary: "Check Codex, Claude, and Gemini status from menu bar at a glance: remaining quota, credits, limits like Spark/Fable, and reset trend for each service, without opening terminals.",
    theme: "blue",
  ...
  },
  {
    ...
    platforms: [
      {
        ...
        status: "공개",
        detail: "0.7.0 · Return 빠른 답변 · ⌘Return 앱에서 깊게 · ⌥Return 새 대화",
        url: "https://github.com/armsone/Alfred-AI-Search/releases/download/v0.7.0/Alfred-AI-Search-0.7.0.alfredworkflow",
        downloadLabel: "Alfred 워크플로우 받기",
        checksum: "f7b691b10bed69efd5423f7c5f711b62f89221fb7bc18c796acdaa1c78da999f",
    ...
    features: [
      ...
      { title: "⌘Return으로 AI 앱에서 깊게", body: "더 깊게 이어갈 때는 질문을 입력한 채 ⌘Return을 누릅니다. 현재 질문을 복사해 선택한 AI 앱을 열지만 자동으로 전송하지 않아 작성 중인 내용을 덮어쓰지 않습니다.", icon: "/apps/alfred-ai-search/providers/gemini.png" },
    ...
    guide: [
      ...
      { title: "⌘Return으로 깊게 이어가기", body: "더 긴 대화가 필요하면 질문을 입력한 상태에서 ⌘Return을 누릅니다. 질문은 클립보드에 준비되며 앱에서 붙여넣기와 전송은 사용자가 직접 결정합니다." },
    ],
    progress: [
      { state: "done", title: "0.7.0 공개", body: "Return은 빠른 답변, ⌘Return은 AI 앱에서 깊게 이어가기, ⌥Return은 새 대화로 조작을 통일하고 배포 파일의 버전과 SHA-256을 확인했습니다." },
