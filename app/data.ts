...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "Google TV 리모컨 지원 준비", body: "다음 공개 Android 빌드부터 TV 첫 화면 배너, 10-foot 가로 화면과 D-pad 시작·중지·설정·테마·밝기·시계 크기 제어를 제공합니다. Google TV와 Android TV API 36 가상 기기 검증을 마쳤고 실제 TV의 리모컨 촉감과 제조사 런처 차이를 최종 확인 중입니다." },
    ...
    guide: [
      ...
      { title: "Google TV에서", body: "다음 공개 Android 빌드를 설치하면 TV 앱 목록에서 S.tand 배너를 고르고, 방향키와 가운데 선택 버튼으로 시작·중지와 홈 제어를 사용합니다. 카메라·플래시가 필요한 기능은 TV에서 숨기거나 지원 제한을 알려줍니다." },
    ...
    progress: [
      ...
      { state: "active", title: "Android 설정 화면 동기화", body: "iOS와 같은 인터넷 라디오 바로가기, 6개 음악 채널 통합 목록과 가로·태블릿 독립 패널 배치를 다음 Android판에 반영" },
      { state: "active", title: "Google TV 다음 공개판", body: "TV 런처 배너와 D-pad 전용 흐름을 API 36 Google TV·Android TV 가상 기기에서 검증 완료 · 실제 TV 최종 확인과 공개 빌드 반영 대기" },
