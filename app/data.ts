...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    platforms: [
      {
        name: "iPhone · iPad",
        status: "TestFlight",
        detail: "0.1.1 (202609020939) · iOS·iPadOS 17+",
        url: "https://testflight.apple.com/join/q9jesHZa",
        downloadLabel: "Public Beta 참여",
        availabilityNote: "공개 링크 10,000명 활성 · 첫 외부 베타 Apple 심사 대기",
      },
    ...
    features: [
      ...
      { title: "원형 그래프에서 시작한 세 가지 테마", body: "민트·오렌지·블루 원형 그래프 테마를 대표로, 밝은 낮빛과 어두운 야간 테마를 고르면 화면 색감과 홈 화면 아이콘이 함께 바뀝니다." },
    ...
    progress: [
      { state: "active", title: "iPhone·iPad 0.1.1 Public Beta 심사", body: "원형 그래프 대표 아이콘, 낮빛·야간 대체 아이콘과 화면 테마, iCloud 읽기 전용 동기화, Files 보조 불러오기를 담은 build 202609020939를 Public Beta 10,000명 그룹에 연결하고 Apple 외부 베타 심사에 제출했습니다." },
  ...
  },
  {
    ...
    platforms: [
      { name: "iPhone · iPad", status: "TestFlight", detail: "2.6.0 · 빌드 202608292118 · iOS·iPadOS 18+", availabilityNote: "2.6.0 Public Beta 승인 · 공개 테스트 참여 가능" },
      {
        ...
        url: releaseDownloadPath("iManagerAI-Android"),
        downloadLabel: "Android APK 바로 받기",
    ...
    features: [
      ...
      { title: "결과를 안정적으로 가져오기", body: "외부 AI의 완성된 답변을 감지해 iManagerAI 초안으로 바로 가져옵니다. 결과를 받거나 화면을 스크롤하면 입력 키보드는 다시 입력창을 누를 때까지 숨깁니다." },
      ...
      { title: "사진 앱에서 바로 시작", body: "사진 앱의 공유 메뉴에서 사진을 최대 8장까지 iManagerAI로 보내면 공동 보관함을 거쳐 새 자동화 캔버스에 바로 채웁니다." },
      { title: "내가 켤 때만 자동화", body: "자동화는 처음에는 꺼져 있습니다. 설정에서 직접 켜면 앱을 열거나 15초 이상 쉬었다 돌아올 때 사진 선택부터 Gemini·ChatGPT·Claude 전달까지 이어집니다." },
      { title: "공유와 카메라는 언제나", body: "자동화를 꺼 둬도 사진 앱에서 바로 공유할 수 있고, 홈 화면의 iManagerAI 아이콘을 길게 눌러 카메라를 곧바로 열 수 있습니다." },
      { title: "인터스텔라 테마", body: "BK·클래식과 함께 은빛과 금빛이 도는 어두운 인터스텔라 화면과 전용 앱 아이콘을 선택할 수 있습니다." },
      { title: "취소와 붙여넣기 안내", body: "게시물 만들기에서 취소를 누르면 작성 중인 내용을 버릴지 확인할 수 있습니다. iPhone·iPad에서 붙여넣기가 막히면 설정 → 앱 → iManagerAI → 다른 앱에서 붙여넣기를 허용으로 바꾸고, Android는 앱별 붙여넣기 권한을 따로 설정하지 않습니다." },
    ],
    guide: [
      { title: "미디어와 이야기 입력", body: "사진·영상 또는 카메라로 미디어를 먼저 고르고 이야기를 적습니다. 사진만, 사진과 글, 글만 모두 가능합니다." },
      { title: "사진 앱에서 보내기", body: "사진 앱에서 사진을 고르고 공유 → iManagerAI를 누르면 사진이 자동화 캔버스에 바로 들어옵니다." },
      ...
      { title: "결과 가져오기", body: "외부 AI의 답변이 완성되면 iManagerAI가 결과를 가져와 미리보기에 표시합니다. 로그인하지 않았다면 나의 취향 아래쪽 외부 AI 로그인 관리에서 먼저 로그인합니다." },
      ...
      { title: "브라우저 보기와 붙여넣기", body: "외부 AI 화면을 계속 보려면 나의 취향 → 외부 AI 로그인 관리에서 브라우저 보기를 켭니다. iPhone·iPad 붙여넣기가 막히면 설정 → 앱 → iManagerAI → 다른 앱에서 붙여넣기 → 허용을 선택합니다." },
    ],
    progress: [
    ...
    screenshots: [
      { src: "/apps/starmanager/screens/ios-composer.png", alt: "iManagerAI iPhone 스튜디오의 AI 선택과 새 캔버스 화면" },
      { src: "/apps/starmanager/screens/android-composer.png", alt: "iManagerAI Android 만들기 화면" },
      { src: "/apps/starmanager/screens/android-result.png", alt: "iManagerAI Android 게시물 생성 결과" },
      { src: "/apps/starmanager/screens/android-settings.png", alt: "iManagerAI Android 내 설정 화면" },
      { src: "/apps/starmanager/screens/android-ai-login.png", alt: "iManagerAI Android 앱 안에서 연 ChatGPT 공식 로그인 화면" },
      { src: "/apps/starmanager/screens/ios-style-settings.png", alt: "iManagerAI iPhone에서 펼친 글 스타일 설정" },
      { src: "/apps/starmanager/screens/android-style-settings.png", alt: "iManagerAI Android에서 펼친 글 스타일 설정" },
    ],
    github: [
      "https://github.com/armsone/iManagerAI",
      "https://github.com/armsone/iManagerAI-Android",
    ],
    privacy: [
      ...
      "외부 AI 로그인 정보는 iManagerAI가 직접 보거나 저장하지 않으며, 각 서비스의 웹 로그인 세션은 이 기기의 앱 전용 웹 데이터에 유지됩니다.",
  ...
  },
  {
    ...
    platforms: [
      {
        name: "iManagerAI · iOS · Android",
        status: "공개",
        detail: "AIBI 0.4.4 · Apple·Android 공통 엔진 · iManagerAI 동기화 완료",
        ...
        availabilityNote: "독립 소스 공개 · iManagerAI에는 검증된 같은 엔진 포함",
      },
    ],
    features: [
    ...
    guide: [
      { title: "앱에서 AI 선택", body: "iManagerAI에서 Gemini·ChatGPT·Claude 중 하나를 누르면 별도 확인 단계 없이 아이비 작업이 시작됩니다." },
      ...
      { title: "검증된 결과 받기", body: "생성이 끝나고 결과가 안정되면 iManagerAI의 문체와 길이 규칙을 확인해 본문에 반영하고 브라우저를 정리합니다." },
    ],
    progress: [
      { state: "done", title: "독립 기준 프로젝트 0.4.4 공개", body: "공통 계약, 제공자 변화 대응 절차, Apple·Android 엔진과 iManagerAI 배포 스냅샷을 검증해 독립 소스 릴리즈로 공개" },
      ...
      { state: "done", title: "iManagerAI iOS 이식", body: "공유 WKWebView 세션, 숨김·보이기 실행, 로그인 판정, 결과 안정화, 1:59 제한과 취소 흐름을 빌드 검증" },
      { state: "done", title: "iManagerAI Android 이식", body: "EXIF 방향 보정·순차 축소·FileProvider 다중 첨부·숨김 키보드 정리와 로그인 관리를 연결하고 3대의 Android 기기에서 배포 빌드 설치·실행 검증" },
