...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    summary: "전하고 싶은 이야기를 한 줄로 적고 원하는 결과를 고르면, ChatGPT·Gemini·Claude 또는 기기 AI가 내 목소리에 맞는 게시물 초안을 완성합니다. 결과를 안정적으로 가져와 사진·영상과 함께 Instagram 등 원하는 앱으로 바로 이어가는 iPhone·iPad·Android 앱입니다.",
    theme: "violet",
    icon: "/apps/starmanager/icon.png",
    artwork: "phones",
    platforms: [
      { name: "iPhone · iPad", status: "TestFlight", detail: "2.2.0 · 빌드 202608280732 · iOS·iPadOS 18+", availabilityNote: "2.2.0 Public Beta 심사 대기 · 공개 링크에서는 승인된 이전 빌드 테스트 가능" },
      {
        name: "Android",
        status: "공개",
        detail: "2.2.0 · 빌드 202608280732 · 내부 코드 344612 · Android 8.0+",
        url: releaseDownloadPath("StarManager-Android"),
        downloadLabel: "Android APK 바로 받기",
        checksum: "33cbe25ecb6921d23c8d8ddb5583a4e157014d6d9df0a7131d692a55a246f338",
        availabilityNote: "휴대전화·태블릿·Google TV 지원 · 기존 설치를 유지하는 업데이트 APK 공개",
      },
    ],
    features: [
      { title: "한 줄에서 바로 시작", body: "내가 입력한 내용과 원하는 결과를 중심으로, 필요할 때만 추가 요청을 더하는 간결한 구조로 초안을 만듭니다." },
      ...
      { title: "간결해진 나의 취향", body: "프리셋과 기본 말투·이모지·글쓰기 취향만 남겨 자주 쓰는 설정을 빠르게 관리합니다. 외부 AI 로그인, 앱 업데이트, 테마 관리는 화면 아래에서 찾을 수 있습니다." },
    ...
    guide: [
      { title: "이야기 입력", body: "스튜디오에서 전하고 싶은 내용을 한 줄로 적고 원하는 결과를 고릅니다. 더 필요한 조건이 있을 때만 추가 요청을 적습니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Android 2.2.0 공개", body: "제품 2.2.0 · 빌드 202608280732 · 내부 코드 344612의 휴대전화·태블릿·Google TV 지원 APK를 GitHub Releases에 공개" },
      { state: "done", title: "iPhone 2.2.0 실기기 설치", body: "대표 iPhone에 2.2.0 (202608280732)을 교체 설치하고 실행 확인" },
      { state: "active", title: "iOS·iPadOS 2.2.0 Public Beta 심사", body: "build 202608280732를 Public Beta 그룹에 추가하고 테스터 알림과 Beta App Review를 제출했으며 기존 공개 테스트 링크는 유지" },
