  ...
  },
  {
    ...
    platforms: [
      { name: "iOS · iPadOS", status: "TestFlight", detail: "2.1.1 (202608251857) · 내부 build 340977 · iOS·iPadOS 17+", availabilityNote: "Public Beta 심사 제출 · Apple 심사 대기 중" },
      {
        name: "macOS",
        status: "공개",
        detail: "2.1.1 (202608251857) · macOS 14+ · Apple 공증 완료",
        url: releaseDownloadPath("S.tand-macOS"),
        downloadLabel: "Mac용 DMG 바로 받기",
        checksum: "1dcd466114735050d57395e62f9ee48ca1ee3fb07ad8e48c136e8fde3bf21aa8",
      },
      {
    ...
    features: [
      ...
      { title: "두 줄 음악·제어 카드", body: "음악과 잠소리·보이소·설정을 아이콘과 제목, 상태의 두 줄로 또렷하게 보여 줍니다. 인터넷 라디오는 카드의 왼쪽 절반으로 재생·일시정지하고 오른쪽 절반으로 다음 채널을 고르며, 음악 스트립을 밀면 볼륨 대신 채널 카드만 움직입니다." },
    ...
    guide: [
      ...
      { title: "음악 채널", body: "Apple 기기에서는 Apple Music·Apple Music Classical과 인터넷 라디오 네 칸을, Android에서는 Spotify·YouTube Music과 인터넷 라디오 네 칸을 한 줄에서 좌우로 넘깁니다. Android 인터넷 라디오 카드는 왼쪽 절반이 재생·일시정지, 오른쪽 절반이 다음 라디오이며 설정에서 여섯 칸의 순서와 라디오 이름·주소를 편집합니다." },
