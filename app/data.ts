...
export const apps: AppData[] = [
  {
    ...
    summary: "NAS·클라우드·네트워크 장비를 한곳에 연결해 먼저 보고 재생합니다. 파일 앱·폰하드·Live Photo↔Motion Photo 전송까지 이어지는 파일 앱입니다.",
    theme: "violet",
    icon: "/apps/nasfinder/icon.png",
    artwork: "files",
    platforms: [
      { name: "iPhone · iPad", status: "TestFlight", detail: "1.3 (202608221416) · iOS·iPadOS 17+", availabilityNote: "TestFlight로 설치 · 공개 스토어 링크 준비 중" },
      { name: "Mac용 NasFinder", status: "TestFlight", detail: "Apple Silicon · iPhone·iPad 호환 앱", availabilityNote: "같은 TestFlight 빌드로 설치 · 공개 스토어 링크 준비 중" },
      {
        name: "Android",
        status: "공개",
        detail: "1.3 · APK v9 · Android 8.0+",
        url: "https://github.com/armsone/NasFinder-Android/releases/download/android-v9/NasFinder-Android-v9.apk",
        downloadLabel: "Android APK 바로 받기",
        checksum: "2297ebff6024f9bfdfcfec4c02a3f6bd370e3157ae98e1e27781ef1884149168",
      },
    ],
    features: [
      ...
      { title: "Google Photos에서 직접 선택", body: "iPhone·iPad에서 Google Photos Picker를 열어 사용자가 직접 고른 사진·영상만 받은 파일함으로 내려받고, 미리보기·공유·삭제하거나 사용자가 선택한 NAS·연결 저장소로 전송합니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Android 공개", body: "BK Style과 받은 파일 선택 삭제를 담은 NasFinder Android v9 APK를 GitHub Releases에 공개" },
    ],
    screenshots: [
  ...
  },
  {
    ...
    summary: "가족 기기를 QR로 여러 공간에 묶고 톡톡·띵동·음성과 긴급 사이렌을 보내는 iPhone·Android 가족 호출 앱입니다. 가까운 기기는 직접 연결하고, 개인 NAS가 iPhone의 APNs와 Android의 FCM을 함께 중계합니다.",
    theme: "coral",
    icon: "/apps/button/icon.png",
    artwork: "phones",
    platforms: [
      { name: "iPhone", status: "완료", detail: "1.2.1 (19) · iOS 17+", availabilityNote: "TestFlight 업로드 완료" },
      {
        name: "Android",
        status: "공개",
        detail: "1.2.2 (20) · Android 8.0+",
        url: "https://github.com/armsone/button-Android/releases/download/v1.2.2/Button-Android-v1.2.2-build20.apk",
        downloadLabel: "Android APK 바로 받기",
        checksum: "637ef269068ea19f4070e5f1545b14f4dd49c0877c2612a1edb614e75e515ef5",
      },
    ],
    features: [
    ...
    progress: [
      ...
      { state: "done", title: "iPhone 1.2.1 업로드", body: "여러 사람 선택과 화면 유지를 반영한 build 19를 TestFlight에 업로드" },
      { state: "done", title: "Android 1.2.2 공개", body: "Firebase 원격 수신 설정과 여러 사람 선택을 반영한 서명 build 20 APK와 체크섬을 GitHub Releases에 공개" },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "원하는 AI를 먼저 선택", body: "ChatGPT·Gemini·Grok·기기 AI를 같은 자리에서 고릅니다. 외부 앱을 열 때는 어디로 왜 이동하는지 먼저 알려 줍니다." },
    ...
    guide: [
      ...
      { title: "초안 만들기", body: "사용할 AI를 고른 뒤 화면에서 가장 눈에 띄는 만들기 버튼을 누릅니다." },
    ...
    progress: [
      ...
      { state: "done", title: "Android 0.1.2 공개", body: "AI 선택 흐름, 새 캔버스와 새 디자인을 반영한 Android 0.1.2 APK를 GitHub Releases에 공개" },
      ...
      { state: "next", title: "iOS 0.1.2 배포 준비", body: "새 스튜디오 화면과 안전한 초기화 흐름의 빌드 검증 완료, TestFlight 서명 복구 후 업로드" },
    ],
    screenshots: [
